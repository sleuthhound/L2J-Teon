...
public final class L2ArtefactInstance extends L2NpcInstance
{
	...
	/**
	 * @see net.sf.l2j.gameserver.model.actor.L2Npc#onSpawn()
	 */
	@Override
	public void onSpawn()
	{
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Set the L2Npc as target of the L2PcInstance player (if necessary)</li> <li>Send a Server->Client packet MyTargetSelected to the L2PcInstance player (display the select window)</li> <li>Send a Server->Client packet ValidateLocation to correct the L2Npc position and heading on the client</li>
	 * <BR>
	 * <BR>
