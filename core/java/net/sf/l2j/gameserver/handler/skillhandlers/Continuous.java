...
public class Continuous implements ISkillHandler
{
	...
	public void useSkill(L2Character activeChar, L2Skill skill, L2Object[] targets)
	{
		...
		final boolean ss = activeChar.isSoulshotCharged(skill);
		final boolean sps = activeChar.isSpiritshotCharged(skill);
		final boolean bsps = activeChar.isBlessedSpiritshotCharged(skill);
