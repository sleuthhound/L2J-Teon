...
public class L2SkillDrain extends L2Skill
{
	...
	public void useSkill(L2Character activeChar, L2Object[] targets)
	{
		...
		final boolean sps = activeChar.isSpiritshotCharged(this);
		final boolean bsps = activeChar.isBlessedSpiritshotCharged(this);
		...
		activeChar.spsUncharge(isStaticReuse());
	}
