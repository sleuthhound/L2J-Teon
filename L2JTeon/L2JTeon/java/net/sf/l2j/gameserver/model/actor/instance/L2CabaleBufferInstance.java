...
public class L2CabaleBufferInstance extends L2NpcInstance
{
	...
	public void run()
	{
	     ...
	     * negative buff. <BR>
	     * The stats affected depend on the player type, either a
	     * fighter or a mystic. <BR>
	     * <BR>
	     * Curse of Destruction (Loser)<BR> - Fighters: -25% Accuracy,
	     * -25% Effect Resistance<BR> - Mystics: -25% Casting Speed,
	     * -25% Effect Resistance<BR>
	     * <BR>
	     * <BR>
	     * Blessing of Prophecy (Winner) - Fighters: +25% Max Load, +25%
	     * Effect Resistance<BR> - Mystics: +25% Magic Cancel Resist,
	     * +25% Effect Resistance<BR>
	     */
