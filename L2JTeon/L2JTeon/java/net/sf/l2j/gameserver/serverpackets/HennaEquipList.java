...
public class HennaEquipList extends L2GameServerPacket
{
	...
	{
	    /*
	     * Player must have at least one dye in inventory to be able to
	     * see the henna that can be applied with it.
	     */
		...
		writeD(_hennaEquipList[i].getAmountDyeRequire()); // amount
		// of
		// dye
		// require
		writeD(_hennaEquipList[i].getPrice()); // amount of aden
		// require
