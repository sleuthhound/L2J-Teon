 ...
 * </ul>
 * <p>
 * These are all channel-modes defined in RFC1459. Nevertheless, most networks
 * provide more channel-modes. This class can handle all modes; it's not
 * restricted to the rights defined in RFC1459.
 * 
...
{
    /**
     * Represents the operators, modes and nicks as they were sent from the
     * IRC server.
     */
    private String line;
    /**
     * Contains pluses (<code>+</code>) and minuses (<code>-</code>)
     * which show if the mode is taken or given.
     */
     ...
     * or <code>-</code>), modes (one character) and optional arguments
     * (one word or number).
     * 
     * @param line
     ...
     * <code>i</code>, <code>s</code>, <code>o</code> or any other
     * mode). The <code>String[]</code> contains the nicknames.
     * 
     * @param modes
     *                The modes (for example <code>+oo+m-v</code>).
     * @param args
    ...
    // ------------------------------
    /**
     * Returns the amount of modes in the string. This is done by counting
     * all chars which are not <code>+</code> or <code>-</code>.
     * 
     * @param modes
    ...
    // ------------------------------
    /**
     * Returns the operator (<code>+</code> or <code>-</code>) of a
     * given index.
     * 
     * @param i
     *                The index of the operator you want to get. The index
     *                starts with <code>1</code> and not with
     *                <code>0</code>.
     * @return The operator at the given index (<code>+</code> or
     *         <code>-</code>).
     * @see #getCount()
     * @see #getModeAt(int)
     * @see #getArgAt(int)
     ...
     * 
     * @param i
     *                The index of the mode you want to get. The index
     *                starts with <code>1</code> and not with
     *                <code>0</code>.
     ...
     * 
     * @param i
     *                The index of the argument you want to get. The index
     *                starts with <code>1</code> and not with
     *                <code>0</code>.
     * @return The argument you requested. It's <code>""</code> if there's
     *         no argument at this index (for example <code>+m</code> for
     *         moderated has never an argument).
     * @see #getCount()
     * @see #getOperatorAt(int)
     * @see #getModeAt(int)
     */
    ...
    // ------------------------------
    /**
     * Returns the line as it was sent from the IRC server. The line
     * contains the the operators, the modes and the nicknames, but not the
     * channel or the nickname who executed the MODE command!
     * 
     * @return The line which was set as argument when the parser was
     *         initialized.
     */
     ...
     * instance of <code>IRCModeParser</code>. Its format is:
