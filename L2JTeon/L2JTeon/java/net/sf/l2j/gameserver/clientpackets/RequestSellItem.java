...
public final class RequestSellItem extends L2GameClientPacket
{
     ...
     * 
     * 71 72 00 10 // object id ea 05 00 00 // item id 01 00 00 00 // item
     * count
     * 
     * 76 4b 00 10 // object id 2e 0a 00 00 // item id 01 00 00 00 // item
     * count
     * 
     * format: cdd (ddd)
     * 
	...
	for (int i = 0; i < _count; i++)
	{
	     ...
	     * item.getReferencePrice()*(int)count/2; L2ItemInstance li =
	     * null; L2ItemInstance la = null; if (_listId > 1000000) { li =
	     * merchant.findLeaseItem(item.getItemId(),item.getEnchantLevel());
	     * la = merchant.getLeaseAdena(); if (li == null || la == null)
	     * continue; price = li.getPriceToBuy()*(int)count; // player
	     * sells, thus merchant buys. if (price > la.getCount())
	     * continue; }
	     */
	    /*
