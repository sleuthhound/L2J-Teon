...
public final class PrimeFinder
{
     ...
     * 
     * A chunk starts with a prime P1. The next element is a prime P2. P2 is
     * the smallest prime for which holds: P2 >= 2*P1.
     * 
     ...
     * "rounding to a prime" upon hashtable construction, it will later
     * expand to prime capacities such that there exist no better primes.
     * 
