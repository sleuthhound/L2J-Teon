...
public final class ExternalConfig
{
	...
	public static void loadconfig()
	{
		...
		try
		{
			...
			if (Interval_Of_Valakas_Spawn < 1 || Interval_Of_Valakas_Spawn > 192)
			...
			if (Interval_Of_Baium_Spawn < 1 || Interval_Of_Baium_Spawn > 192)
			...
			if (Interval_Of_Baylor_Spawn < 1 || Interval_Of_Baylor_Spawn > 192)
				Interval_Of_Baylor_Spawn = 12;
			...
			if (Random_Of_Baylor_Spawn < 1 || Random_Of_Baylor_Spawn > 192)
				Random_Of_Baylor_Spawn = 24;
			...
			if (Interval_Of_Frintezza_Spawn < 1 || Interval_Of_Frintezza_Spawn > 192)
