...
{
    /**
     * Min level that the player must achieve to obtain this buff from
     * Newbie Helper
     */
    private int _lowerLevel;
    /**
     * Max level that the player mustn't exceed if it want to obtain this
     * buff from Newbie Helper
     */
    ...
    /**
     * Returns the lower level that the L2PcInstance must achieve in order
     * to obtain this buff
     * 
     * @return int
     */
    ...
    /**
     * Returns the upper level that the L2PcInstance mustn't exceed in order
     * to obtain this buff
     * 
     * @return int
     */
