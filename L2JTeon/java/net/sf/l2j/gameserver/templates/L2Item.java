...
public abstract class L2Item
{
     ...
     * @param set :
     *                StatsSet corresponding to a set of couples (key,value)
    ...
    /**
     * Returns the quantity of crystals for crystallization on specific
     * enchant level
     * 
     * @return int
     */
    ...
    /**
     * Returns array of Func objects containing the list of functions used
     * by the item
     * 
     * @param instance :
