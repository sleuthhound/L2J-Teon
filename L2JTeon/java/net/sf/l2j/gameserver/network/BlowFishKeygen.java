...
public class BlowFishKeygen
{
    ...
    /**
     * Returns a key from this keygen pool, the logical ownership is
     * retained by this keygen.<BR>
     * Thus when getting a key with interests other then read-only a copy
