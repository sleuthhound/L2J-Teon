...
{
    /**
     * ID: 1 Message: The server will be coming down in [x] second(s).
     * Please find the safe place to log out. On Screen Text: Exit Game [x]
     * second(s).
     */
    ...
    /**
     * ID: 977<br>
     * Message: The soul crystals caused resonation and failed at absorbing
     * a soul.
     */
    ...
    /**
     * ID: 607<br>
     * Message: You do not have any further skills to learn. Come back when
     * you have reached Level $s1.
     */
    ...
    /**
     * ID: 297<br>
     * Message: You have taken $s1 damage because you were unable to
     * breathe.
     */
    DROWN_DAMAGE_S1(297),
    /**
    ...
    /**
     * ID: 1053<br>
     * Message: It is not possible to resurrect in battlefields where a
     * siege war is taking place.
     */
    ...
    /**
     * ID: 337<br>
     * Message: The soulshot you are attempting to use does not match the
     * grade of your equipped weapon.
     */
    ...
    /**
     * ID: 136<br>
     * Message: You have not replied to $s1's invitation), the offer has
     * been canceled.
     */
    ...
    /**
     * ID: 1399<br>
     * Message: Only the leader of the party can transfer party leadership
     * to another player.
     */
    ...
    /**
     * ID: 1402<br>
     * Message: You may only transfer party leadership to another member of
     * the party.
     */
    ...
    /**
     * ID: 112<br>
     * Message: You may no longer adjust items in the trade because the
    ...
    /**
     * ID: 224<br>
     * Message: $s1 did not respond: Invitation to the clan has been
     * cancelled.
     */
    ...
    /**
     * ID: 477<br>
     * Message: No response. Invitation to join an alliance has been
     * cancelled.
     */
    NO_RESPONSE_TO_ALLY_INVITATION(477),
    /**
     * ID: 478<br>
     * Message: No response. Your entrance to the alliance has been
     * cancelled.
     */
    ...
    /**
     * ID: 720<br>
     * Message: The purchase price is higher than the amount of money that
     * you have and so you cannot open a personal store.
     */
    ...
    /**
     * ID: 1065<br>
     * Message: While operating a private store or workshop, you cannot
     * discard, destroy, or trade an item.
     */
    ...
    /**
     * ID: 271<br>
     * Message: A player can only be granted a title if the clan is level 3
     * or above
     */
    ...
    /**
     * ID: 272<br>
     * Message: A clan crest can only be registered when the clan's skill
     * level is 3 or above.
     */
    CLAN_LVL_3_NEEDED_TO_SET_CREST(272),
    /**
     * ID: 552<br>
     * Message: During the grace period for dissolving a clan, the
     * registration or deletion of a clan's crest is not allowed.
     */
    ...
    /**
     * ID: 1791<br>
     * Message: The conditions necessary to create a military unit have not
     * been met.
     */
    ...
    /**
     * ID: 1855<br>
     * Message: Another military unit is already using that name. Please
    ...
    /**
     * ID: 67<br>
     * Message: $s1 has invited you to the join the clan, $s2. Do you wish
     * to join?
     */
    ...
    /**
     * ID: 1734<br>
     * Message: To join a Clan Academy, characters must be Level 40 or
     * below, not belong another clan and not yet completed their 2nd class
     * transfer.
     */
    ...
    /**
     * ID: 1835<br>
     * Message: #$s1 is full and cannot accept additional clan members at
     * this time.
     */
    ...
    /**
     * ID: 1748<br>
     * Message: Clan Academy member $s1 has successfully completed the 2nd
     * class transfer and obtained $s2 Clan Reputation points.
     */
     ...
     * immediately join a clan as a regular member without being subject to
     * any penalties
     */
    ...
    /**
     * ID: 1772<br>
     * Message: Since your clan was defeated in a siege, $s1 points have
     * been deducted from your clan's reputation score and given to the
     * opposing clan.
     */
    CLAN_WAS_DEFEATED_IN_SIEGE_AND_LOST_S1_REPUTATION_POINTS(1772),
    /**
     * ID: 1773<br>
     * Message: Since your clan emerged victorious from the siege, $s1
     * points have been added to your clan's reputation score.
     */
    ...
    /**
     * ID: 1775<br>
     * Message: Clan member $s1 was an active member of the highest-ranked
     * party in the Festival of Darkness. $s2 points have been added to your
    ...
    /**
     * ID: 1776<br>
     * Message: Clan member $s1 was named a hero. $2s points have been added
     * to your clan's reputation score.
     */
    CLAN_MEMBER_S1_BECAME_HERO_AND_GAINED_S2_REPUTATION_POINTS(1776),
    /**
     * ID: 1777<br>
     * Message: You have successfully completed a clan quest. $s1 points
     * have been added to your clan's reputation score.
     */
    CLAN_QUEST_COMPLETED_AND_S1_POINTS_GAINED(1777),
    /**
     * ID: 1778<br>
     * Message: An opposing clan has captured your clan's contested clan
     * hall. $s1 points have been deducted from your clan's reputation
     * score.
     */
    ...
    /**
     * ID: 1780<br>
     * Message: Your clan has captured your opponent's contested clan hall.
     * $s1 points have been deducted from your opponent's clan reputation
     * score.
     */
    ...
    /**
     * ID: 1782<br>
     * Message: Your clan member $s1 was killed. $s2 points have been
     * deducted from your clan's reputation score and added to your
    ...
    /**
     * ID: 1784<br>
     * Message: Your clan has failed to defend the castle. $s1 points have
     * been deducted from your clan's reputation score and added to your
     * opponents'.
     */
    ...
    /**
     * ID: 1789<br>
     * Message: Since the Clan Reputation Score has dropped to 0 or lower,
     * your clan skill(s) will be de-activated.
     */
    ...
    /**
     * ID: 1862<br>
     * Message: Clan skills will now be activated since the clan's
     * reputation score is 0 or higher.
     */
    CLAN_SKILLS_WILL_BE_ACTIVATED_SINCE_REPUTATION_IS_0_OR_HIGHER(1862),
    /**
     * ID: 1790<br>
     * Message: The conditions necessary to increase the clan's level have
     * not been met.
     */
    FAILED_TO_INCREASE_CLAN_LEVEL(1790),
    /**
     * ID: 540<br>
     * Message: Clan leaders may not be deleted. Dissolve the clan first and
     * try again.
     */
    CLAN_LEADERS_MAY_NOT_BE_DELETED(540),
    /**
     * ID: 541<br>
     * Message: You may not delete a clan member. Withdraw from the clan
     * first and try again.
     */
    ...
    /**
     * ID: 265<br>
     * Message: You cannot dissolve a clan during a siege or while
     * protecting a castle.
     */
    CANNOT_DISSOLVE_WHILE_IN_SIEGE(265),
    /**
     * ID: 266<br>
     * Message: You cannot dissolve a clan while owning a clan hall or
     * castle.
     */
    CANNOT_DISSOLVE_WHILE_OWNING_CLAN_HALL_OR_CASTLE(266),
    /**
     * ID: 13<br>
     * Message: Unable to disperse: your clan has requested to participate
     * in a castle siege.
     */
    CANNOT_DISSOLVE_CAUSE_CLAN_WILL_PARTICIPATE_IN_CASTLE_SIEGE(13),
    /**
     * ID: 551<br>
     * Message: You cannot raise your clan level during the term of
     * dispersion postponement.
     */
    ...
    /**
     * ID: 1114<br>
     * Message: Your clan may not register to participate in a siege while
     * under a grace period of the clan's dissolution.
     */
    ...
    /**
     * ID: 710<br>
     * Message: Only clans of clan level 1 or higher can use a clan
     * warehouse.
     */
    ONLY_LEVEL_1_CLAN_OR_HIGHER_CAN_USE_WAREHOUSE(710),
    /**
     * ID: 1039<br>
     * Message: Items left at the clan hall warehouse can only be retrieved
     * by the clan leader. Do you want to continue?
     */
    ...
    /**
     * ID: 1564<br>
     * Message: A Clan War can be declared only if the clan is level three
     * or above, and the number of clan members is fifteen or greater.
     */
    ...
    /**
     * ID: 1569<br>
     * Message: A declaration of Clan War against an allied clan can't be
     * made.
     */
    ...
    /**
     * ID: 1562<br>
     * Message: A Clan War has been declared against the clan, $s1. If you
     * are killed during the Clan War by members of the opposing clan, you
     * will only lose a quarter of the normal experience from death.
     */
    ...
    */
    ...
    /**
     * ID: 910<br>
     * Message: Current location : $s1, $s2, $s3 (Near Talking Island
     * Village)
     */
    LOC_TI_S1_S2_S3(910),
    /**
    ...
    /**
     * ID: 1714<br>
     * Message: Current Location: $s1, $s2, $s3 (Near the Town of
     * Schuttgart)
     */
    ...
    /**
     * ID: 562<br>
     * Message: You may not crystallize this item. Your crystallization
    ...
    /**
     * ID: 1044<br>
     * Message: Monster race payout information is not available while
    ...
    /**
     * ID: 819<br>
     * Message: Tickets sales are closed for Monster Race $s1. Odds are
     * posted.
     */
    ...
    /**
     * ID: 822<br>
     * Message: Monster Race $s1 is about to begin! Countdown in five
     * seconds!
     */
    ...
    /**
     * ID: 826<br>
     * Message: First prize goes to the player in lane $s1. Second prize
     * goes to the player in lane $s2.
     */
    ...
    /**
     * ID: 1598<br>
     * Message: Soulshots and spiritshots are not available for a dead pet
     * or servitor. Sad, isn't it?
     */
    ...
    /**
     * ID: 1515<br>
     * Message: A pet cannot be resurrected while it's owner is in the
    ...
    /**
     * ID: 1295<br>
     * Message: Sub classes may not be created or changed while a skill is
     * in use.
     */
    ...
    /**
     * ID: 1911<br>
     * Message: You cannot summon players who are currently participating in
     * the Grand Olympiad.
     */
    ...
    /**
     * ID: 65<br>
     * Message: The enchantment has failed! Your +$s1 $s2 has been
     * crystallized.
     */
    ...
    /**
     * ID: 1517<br>
     * Message: Failed in Blessed Enchant. The enchant value of the item
     * became 0.
     */
    ...
    /**
     * ID: 1210<br>
     * Message: Seven Signs: The quest event period has begun. Visit a
     * Priest of Dawn or Priestess of Dusk to participate in the event.
     */
    QUEST_EVENT_PERIOD_BEGUN(1210),
    /**
     * ID: 1211<br>
     * Message: Seven Signs: The quest event period has ended. The next
     * quest event will start in one week.
     */
    ...
    /**
     * ID: 1215<br>
     * Message: Seven Signs: The Revolutionaries of Dusk have obtained the
     * Seal of Avarice.
     */
    ...
    /**
     * ID: 1260<br>
     * Message: Seven Signs: Preparations have begun for the next quest
     * event.
     */
     ...
     * Priest of Dawn or Dusk Priestess if you wish to participate in the
     * event.
     */
    COMPETITION_PERIOD_BEGUN(1261),
    /**
     * ID: 1262<br>
     * Message: Seven Signs: Quest event has ended. Results are being
     * tallied.
     */
    ...
    /**
     * ID: 1275<br>
     * Message: You've chosen to fight for the Seal of Avarice during this
     * quest event period.
     */
    FIGHT_FOR_AVARICE(1275),
    /**
     * ID: 1276<br>
     * Message: You've chosen to fight for the Seal of Gnosis during this
     * quest event period.
     */
    FIGHT_FOR_GNOSIS(1276),
    /**
     * ID: 1277<br>
     * Message: You've chosen to fight for the Seal of Strife during this
     * quest event period.
     */
    FIGHT_FOR_STRIFE(1277),
    /**
     * ID: 1279<br>
     * Message: Contribution level has exceeded the limit. You may not
     * continue.
     */
    ...
    /**
     * ID: 1290<br>
     * Message: Although the seal was not owned, since 35 percent or more
     * people have voted.
     */
    ...
    /**
     * ID: 1294<br>
     * Message: The competition has ended in a tie. Therefore, nobody has
    ...
    /**
     * ID: 1755<br>
     * Message: $s2 has been designated as the apprentice of clan member
     * $s1.
     */
    ...
    /**
     * ID: 626<br>
     * Message: The $s1 clan did not respond: war proclamation has been
     * refused.
     */
    ...
    /**
     * ID: 467<br>
     * Message: You may not accept any clan within a day after expelling
     * another clan.
     */
    CANT_INVITE_CLAN_WITHIN_1_DAY(467),
    /**
     * ID: 468<br>
     * Message: A clan that has withdrawn or been expelled cannot enter into
     * an alliance within one day of withdrawal or expulsion.
     */
    ...
    /**
     * ID: 470<br>
     * Message: Only the clan leader may apply for withdrawal from the
     * alliance.
     */
    ...
    /**
     * ID: 509<br>
     * Message: Cannot accept. clan ally is registered as an enemy during
     * siege battle.
     */
    ...
    /**
     * ID: 550<br>
     * Message: You may not create an alliance during the term of
     * dissolution postponement.
     */
    ...
    /**
     * ID: 761<br>
     * Message: $s1 clan cannot join the alliance because one day has not
     * yet passed since it left another alliance.
     */
    ...
    /**
     * ID: 525<br>
     * Message: You have succeeded in inviting a friend to your friends
     * list.
     */
    ...
    /**
     * ID: 614<br>
     * Message: $s1 $s2<br> ( USE THIS ID TO SEND CUSTOM MESSAGES TO CLIENT )
     */
    S1_S2(614),
    /**
     * ID: 101<br>
    ...
    /**
     * ID: 702 <br>
     * Message: There are no GMs currently visible in the public list as
     * they may be performing other functions at the moment.
     */
    ...
    /**
     * ID: 1112<br>
     * Message: The prize amount for the winner of Lottery #$s1 is $s2
     * adena. We have $s3 first prize winners.
     */
    AMOUNT_FOR_WINNER_S1_IS_S2_ADENA_WE_HAVE_S3_PRIZE_WINNER(1112),
    /**
     * ID: 1113<br>
     * Message: The prize amount for Lucky Lottery #$s1 is $s2 adena. There
     * was no first prize winner in this drawing, therefore the jackpot will
    ...
    /**
     * ID: 381<br>
     * Message: The game client encountered an error and was unable to
     * connect to the petition server.
     */
    ...
    /**
     * ID: 602<br>
     * Message: The petition system is currently unavailable. Please try
     * again later.
     */
     ...
     * the maximum that you can submit in one day. You cannot submit any
     * more petitions.
     */
    ...
    /**
     * ID: 730<br>
     * Message: - You have submitted your $s1th petition. - You may submit
     * $s2 more petition(s) today.
     */
    ...
    /**
     * ID: 736<br>
     * Message: The petition was canceled. You may submit $s1 more
     * petition(s) today.
     */
    ...
    /**
     * ID: 387<br>
     * Message: This ends the GM petition consultation. Please take a moment
     * to provide feedback about this service.
     */
    ...
    /**
     * ID: 830<br>
     * Message: You have recommended $s1. You are authorized to make $s2
    ...
    /**
     * ID: 833<br>
     * Message: You are not authorized to make further recommendations at
     * this time. You will receive more recommendation credits each day at 1
     * p.m.
     */
    ...
    /**
     * ID: 642<br>
     * Message: You are already registered to the attacker side and must
    ...
    /**
     * ID: 1061<br>
     * Message: The recipe cannot be registered. You do not have the ability
     * to create items.
     */
    CANT_REGISTER_NO_ABILITY_TO_CRAFT(1061),
    /**
     * ID: 1135<br>
     * Message: While you are engaged in combat, you cannot operate a
     * private store or private workshop.
     */
    ...
    /**
     * ID: 1604<br>
     * Message: While dressed in formal wear, you can't use items that
     * require all skills and casting operations.
     */
    ...
    /**
     * ID: 1493<br>
     * Message: Your opponent made haste with their tail between their
     * legs), the match has been cancelled.
     */
    THE_GAME_HAS_BEEN_CANCELLED_BECAUSE_THE_OTHER_PARTY_ENDS_THE_GAME(1493),
    /**
     * ID: 1494<br>
     * Message: Your opponent does not meet the requirements to do battle),
    ...
    /**
     * ID: 1502<br>
     * Message: You have already been registered in a waiting list of an
     * event.
     */
     ...
     * and make haste to a Grand Olympiad Manager! Battles in the Grand
     * Olympiad Games are now taking place!
     */
    THE_OLYMPIAD_GAME_HAS_STARTED(1641),
    /**
     * ID: 1642<br>
     * Message: Much carnage has been left for the cleanup crew of the
     * Olympiad Stadium. Battles in the Grand Olympiad Games are now over!
     */
    ...
    /**
     * ID: 1689<br>
     * Message: You have already joined the waiting list for a class
     * specific match.
     */
    ...
    /**
     * ID: 1691<br>
     * Message: You can't join a Grand Olympiad Game match with that much
     * stuff on you! Reduce your weight to below 80 percent full and request
     * to join again!
     */
    ...
    /**
     * ID: 1693<br>
     * Message: You may not observe a Grand Olympiad Games match while you
    ...
    /**
     * ID: 1929<br>
     * Message: $s1 has accepted your challenge to a duel. The duel will
    ...
    /**
     * ID: 1930<br>
     * Message: You have accepted $s1's challenge to a duel. The duel will
     * begin in a few moments.
     */
    ...
    /**
     * ID: 1933<br>
     * Message: You have accepted $s1's challenge to a party duel. The duel
    ...
    /**
     * ID: 1934<br>
     * Message: $s1 has accepted your challenge to duel against their party.
     * The duel will begin in a few moments.
     */
    ...
    /**
     * ID: 1942<br>
     * Message: The opposing party is currently unable to accept a challenge
     * to a duel.
     */
    THE_OPPOSING_PARTY_IS_CURRENTLY_UNABLE_TO_ACCEPT_A_CHALLENGE_TO_A_DUEL(1942),
    /**
     * ID: 1944<br>
     * Message: In a moment, you will be transported to the site where the
     * duel will take place.
     */
    IN_A_MOMENT_YOU_WILL_BE_TRANSPORTED_TO_THE_SITE_WHERE_THE_DUEL_WILL_TAKE_PLACE(
	    1944), THE_DUEL_WILL_BEGIN_IN_S1_SECONDS(1945),
    /**
     * ID: 1949<br>
    ...
    /**
     * ID: 1956<br>
     * Message: Since $s1's party withdrew from the duel, $s2's party has
     * won.
     */
	...
	*/
    ...
    /**
     * ID: 2020<br>
     * Message: $s1 cannot make a challenge to a duel because $s1 is
     * currently in a duel-prohibited area (Peaceful Zone / Seven Signs Zone /
     * Near Water / Restart Prohibited Area).
     */
    ...
    /**
     * ID: 2024<br>
     * Message: $s1 cannot duel because $s1 is participating in the
     * Olympiad.
     */
    S1_CANNOT_DUEL_BECAUSE_S1_IS_PARTICIPATING_IN_THE_OLYMPIAD(2024),
    /**
     * ID: 2025<br>
     * Message: $s1 cannot duel because $s1 is participating in a clan hall
     * war.
     */
    ...
    /**
     * ID: 2027<br>
     * Message: $s1 cannot duel because $s1 is currently riding a boat,
     * wyvern, or strider.
     */
    S1_CANNOT_DUEL_BECAUSE_S1_IS_CURRENTLY_RIDING_A_BOAT_WYVERN_OR_STRIDER(2027),
    /**
     * ID: 2028<br>
     * Message: $s1 cannot receive a duel challenge because $s1 is too far
     * away.
     */
    ...
    /**
     * ID: 1450<br>
     * Message: That fish is more determined than you are - it spit the
     * hook!
     */
    ...
    /**
     * ID: 1466<br>
     * Message: You failed to do anything with the fish and it regains $s1
     * HP.
     */
    ...
    /**
     * ID: 1468<br>
     * Message: You failed to reel that fish in further and it regains $s1
     * HP.
     */
    ...
    /**
     * ID: 1472<br>
     * Message: You look oddly at the fishing pole in disbelief and realize
     * that you can't attack anything with this.
     */
    ...
    /**
     * ID: 1638<br>
     * Message: You cannot fish while using a recipe book, private
     * manufacture or private store.
     */
    CANNOT_FISH_WHILE_USING_RECIPE_BOOK(1638),
    /**
     * ID: 1655<br>
     * Message: You caught something smelly and scary, maybe you should
     * throw it back!?
     */
    ...
    /**
     * ID: 1664<br>
     * Message: The fish is resisting your efforts to haul it in! Look at
     * that bobber go!
     */
    FISH_RESISTING_LOOK_BOBBLER(1664),
    /**
     * ID: 1665<br>
     * Message: You've worn that fish out! It can't even pull the bobber
     * under the water!
     */
    ...
    /**
     * ID: 1439<br>
     * Message: You do not have all of the items needed to enchant that
     * skill.
     */
    ...
    /**
     * ID: 1444<br>
     * Message: You do not have enough experience (Exp) to enchant that
     * skill.
     */
    ...
    /**
     * ID: 1685<br>
     * Message: You are unable to equip this item when your PK count is
     ...
     */
    THE_SEED_HAS_BEEN_SOWN(871), THIS_SEED_MAY_NOT_BE_SOWN_HERE(872), THE_MANOR_SYSTEM_IS_CURRENTLY_UNDER_MAINTENANCE(
	    879), THE_TRANSACTION_IS_COMPLETE(880), THERE_IS_A_DISCREPANCY_ON_THE_INVOICE(
	    881), THE_SEED_QUANTITY_IS_INCORRECT(882), THE_SEED_INFORMATION_IS_INCORRECT(
	    883), THE_MANOR_INFORMATION_HAS_BEEN_UPDATED(884), THE_NUMBER_OF_CROPS_IS_INCORRECT(
	    885), THE_CROPS_ARE_PRICED_INCORRECTLY(886), THE_TYPE_IS_INCORRECT(
	    887), NO_CROPS_CAN_BE_PURCHASED_AT_THIS_TIME(888), THE_SEED_WAS_SUCCESSFULLY_SOWN(
	    889), THE_SEED_WAS_NOT_SOWN(890), YOU_ARE_NOT_AUTHORIZED_TO_HARVEST(
	    891), THE_HARVEST_HAS_FAILED(892), THE_HARVEST_FAILED_BECAUSE_THE_SEED_WAS_NOT_SOWN(
	    893), THE_SEED_PRICING_GREATLY_DIFFERS_FROM_STANDARD_SEED_PRICES(
	    933), THE_AMOUNT_IS_NOT_SUFFICIENT_AND_SO_THE_MANOR_IS_NOT_IN_OPERATION(
	    935), THE_NEXT_SEED_PURCHASE_PRICE_IS_S1_ADENA(104), THE_SALES_PRICE_FOR_SEEDS_IS_S1_ADENA(
	    1058), THE_REMAINDER_AFTER_SELLING_THE_SEEDS_IS_$S1(1060), S1_HARVESTED_S3_S2S(
	    1137), S1_HARVESTED_S2S(1138), TRADED_$S2_OF_CROP_S1(1490), FAILED_IN_TRADING_S2_OF_CROP_S1(
	    1491), THE_TARGET_IS_UNAVAILABLE_FOR_SEEDING(1516), SEED_PRICE_SHOULD_BE_MORE_THAN_S1_AND_LESS_THAN_$S2(
	    1557), THE_QUANTITY_OF_SEED_SHOULD_BE_MORE_THAN_S1_AND_LESS_THAN_S2(
	    1558), CROP_PRICE_SHOULD_BE_MORE_THAN_S1_AND_LESS_THAN_S2(1559), THE_QUANTITY_OF_CROP_SHOULD_BE_MORE_THAN_S1_AND_LESS_THAN_S2(
	    1560), HERE_YOU_CAN_BUY_ONLY_SEEDS_OF_S1_MANOR(1605), A_MANOR_CANNOT_BE_SET_UP_BETWEEN_6_AM_AND_8_PM(
	    1675), YOUR_SEED_OR_REMAINING_PURCHASE_AMOUNT_IS_INADEQUATE(2013),
    /**
     * ID: 1607<br>
