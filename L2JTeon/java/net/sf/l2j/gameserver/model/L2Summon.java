...
public abstract class L2Summon extends L2PlayableInstance
{
     ...
     * <li>Check if the summon owns enough HP and MP to cast the skill
     * </li>
     ...
     * servitor's level. Until level 70, the servitor gets 1 lv of skill per
     * 10 levels. After that, it is 1 skill level per 5 servitor levels. If
     * the resulting skill level doesn't exist use the max that does exist!
     * 
