...
public class CharStatus
{
    ...
    /**
     * Array containing all clients that need to be notified about hp/mp
     * updates of the L2Character
     */
    ...
    /**
     * Add the object to the list of L2Character that must be informed of
     * HP/MP updates of this L2Character.<BR>
     * <BR>
     * 
     * <B><U> Concept</U> :</B><BR>
     * <BR>
     * Each L2Character owns a list called <B>_statusListener</B> that
     * contains all L2PcInstance to inform of HP/MP updates. Players who
     * must be informed are players that target this L2Character. When a
     * RegenTask is in progress sever just need to go through this list to
     * send Server->Client packet StatusUpdate.<BR>
     * <BR>
     * 
	...
	{
	    // If we're dealing with an L2Attackable Instance and the
	    // attacker
	    // hit it with an over-hit enabled skill, set the over-hit
	    // values.
    ...
    /**
     * Remove the object from the list of L2Character that must be informed
     * of HP/MP updates of this L2Character.<BR>
     * <BR>
     * 
     * <B><U> Concept</U> :</B><BR>
     * <BR>
    ...
    /**
     * Return the list of L2Character that must be informed of HP/MP updates
     * of this L2Character.<BR>
     * <BR>
     * 
     * <B><U> Concept</U> :</B><BR>
     * <BR>
	...
	public void run()
	{
		...
		if (!getActiveChar().isInActiveRegion())
		{
		    ...
		    // inactive regions.
		    // stop regeneration for characters who are filled up
		    // and in
		    // an inactive region.
