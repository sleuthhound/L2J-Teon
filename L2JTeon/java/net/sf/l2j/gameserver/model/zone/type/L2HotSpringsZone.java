...
public class L2HotSpringsZone extends L2ZoneType
{
	...
	public L2HotSpringsZone(int id)
	{
		super(id);
	...
	{
		private L2HotSpringsZone _hotspringsZone;
		ApplySkill(L2HotSpringsZone zone)
		{
			_hotspringsZone = zone;
		}

		public void run()
		{
			for (L2Character temp : _hotspringsZone.getCharacterList())
			{
