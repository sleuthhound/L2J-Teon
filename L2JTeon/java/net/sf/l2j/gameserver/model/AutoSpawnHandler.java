...
public class AutoSpawnHandler
{
    ...
    private static final int DEFAULT_INITIAL_SPAWN = 30000; // 30 seconds
    // after
    // registration
    ...
    /**
     * Registers a spawn with the given parameters with the spawner, and
     * marks it as active. Returns a AutoSpawnInstance containing info about
     * the spawn.
     * 
     * @param int
     *                npcId
     ...
     * @param int
     *                despawnDelay (If < 0 = default value or if = 0,
     *                function disabled)
	...
	try
	{
	    // Try to remove from the list of registered spawns if it
	    // exists.
    ...
    /**
     * Returns the number of milliseconds until the next occurrance of the
     * given spawn.
     * 
     * @param AutoSpawnInstance
     *                spawnInst
    ...
    /**
     * Attempts to return the AutoSpawnInstance associated with the given
     * NPC or Object ID type. <BR>
     * Note: If isObjectId == false, returns first instance for the
     * specified NPC ID.
     * 
     * @param int
     *                id
     ...
     * <BR>
     * Simply used as a secondary class for despawning an auto spawn
     * instance.
     * 
     * @author Tempy
     */
