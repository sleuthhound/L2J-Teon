...
public class PcInventory extends Inventory
{
    ...
    /**
     * Returns the list of items in inventory available for transaction
     * Allows an item to appear twice if and only if there is a difference
     * in enchantment level.
     * 
     * @return L2ItemInstance : items in inventory
     */
    ...
    /**
     * Transfers item to another inventory and checks _adena and
     * _ancientAdena
     * 
     * @param process :
     *                String Identifier of process triggering this action
    ...
    /**
     * Destroy item from inventory by using its <B>itemId</B> and checks
     * _adena and _ancientAdena
     * 
     * @param process :
     *                String Identifier of process triggering this action
     * @param itemId :
    ...
    /**
     * Drop item from inventory by using its <B>objectID</B> and checks
     * _adena and _ancientAdena
     * 
     * @param process :
     *                String Identifier of process triggering this action
    ...
    /**
     * <b>Overloaded</b>, when removes item from inventory, remove also
     * owner shortcuts.
     * 
     * @param item :
