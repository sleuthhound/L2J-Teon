...
public class L2Party
{
    ...
    /**
     * returns number of players that already been invited, but not replied
     * yet
     * 
     * @return
     */
    ...
    /**
     * decrease number of players that already been invited but not replied
     * yet happens when: player join party or player decline to join
     */
    ...
    /**
     * increase number of players that already been invite but not replied
     * yet
     */
     ...
     */
    /*
     * private L2PcInstance getNextLooter() { _itemLastLoot++; if
     * (_itemLastLoot > getPartyMembers().size() -1) _itemLastLoot = 0;
     ...
     * temp.sendPacket(msg); temp.sendPacket(new
     * PartySmallWindowDeleteAll()); temp.setParty(null); } }
     */
    /**
    ...
    /**
     * Distribute Experience and SP rewards to L2PcInstance Party members in
     * the known area of the last attacker.<BR>
     * <BR>
     * 
     * <B><U> Actions</U> :</B><BR>
     * <BR>
     ...
     * <BR>
     * Exception are L2PetInstances that leech from the owner's XP; they get
     * the exp indirectly, via the owner's exp gain<BR>
     * 
     * @param xpReward
     ...
     * This method takes in consideration number of members, members'
     * levels, rewarder's level and bonus modifier for the actual party.<BR>
     * <BR>
     * 
     * @param member
     *                is the L2Character to be rewarded
     * @param xpReward
     *                is the total amount of XP to be "splited" and given to
     *                the member
     * @param spReward
     *                is the total amount of SP to be "splited" and given to
     *                the member
     * @param penalty
     *                is the penalty that must be applied to the XP rewards
