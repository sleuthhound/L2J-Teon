...
public class L2EventChecks
{
     ...
     * @return --> true for Eligible Players and false for UnEligible
     *         Players.
     */
	...
	{
	    /*
	     * In case of finding a disconnected player, we will continue
	     * the for statement.
	     */
	    if (member == null)
		continue;
		 ...
		 * about the inconvenience produced. We will also return a
		 * false.
		 */
	    ...
	    /*
	     * Let's count all the points for every one of the event
	     * members, only in the case that the request instance and the
	     * Clan Members are from the same clan
	     */
	    switch (eventType)
	    {
	    case 2:
	 ...
	 * points, we will accept the Participation of this clan in the event
	 */
