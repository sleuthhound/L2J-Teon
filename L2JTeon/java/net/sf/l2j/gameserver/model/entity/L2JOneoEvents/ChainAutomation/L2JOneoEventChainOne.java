...
/**
 * This class is the L2J Oneo Event Chain One which is called upon by the L2J
 * Oneo Event Manager. <br>
 * This class runs the TvT Engine by FBIagent.<br>
 * This class also calls onto the L2J Oneo Event Chain Two.<br>
 * Part of the L2J Event Automation System.<br>
 * 
 * @author Ahmed
 */
public class L2JOneoEventChainOne implements Runnable
{
    public void run()
    {
	if (Config.TVT_EVENT_ENABLED)
	{
	    System.out.println("L2J Oneo Event Manager called TvT Task, and TvT is enabled. Event should Start.");
	...
	{
	    System.out.println("L2J Oneo TvT Task has stopped the L2J Oneo Event Managers execution of the TvT Task due to the TvT Event Engine being disabled.");
	    System.out.println("L2J Oneo VIP Engine is disabled and will not start.");
	    return;
	} else if (!Config.TVT_EVENT_ENABLED && Config.VIP_EVENT_ENABLED)
	{
	    L2JOneoEventChainTwo.run();
	    return;
	}
    }
