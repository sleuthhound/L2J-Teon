...
public class AdminMonsterRace implements IAdminCommandHandler
{
	 ...
	 * of race -1 0 to end the race 8003 to 8027
	 */
	...
	public void run()
	{
	    ...
	    /*
	     * int[] speed = new int[8]; for (int i=0; i<8; i++) { for (int
	     * j=0; j<20; j++) { //System.out.println("Adding
	     * "+speeds1[i][j] +" and "+ speeds2[i][j]); speed[i] +=
	     * (speeds1[i][j]*1);// + (speeds2[i][j]*1); }
