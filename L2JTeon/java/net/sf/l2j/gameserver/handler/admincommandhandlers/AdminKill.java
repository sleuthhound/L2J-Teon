 ...
 * L2Character - kill_monster = kills target non-player - kill <radius> = If
 * radius is specified, then ALL players only in that radius will be killed. -
 * kill_monster <radius> = If radius is specified, then ALL non-players only in
