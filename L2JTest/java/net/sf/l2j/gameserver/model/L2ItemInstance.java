...
public final class L2ItemInstance extends L2Object
{
    ...
    /**
     * Constructor of the L2ItemInstance from the objetId and the
     * description of the item given by the L2Item.
     * 
     * @param objectId :
     *                int designating the ID of the object in the world
     * @param item :
     ...
     * <BR>
     * <U><I>Remark :</I></U> If loc and loc_data different from
     * database, say datas not up-to-date
     * 
     * @param loc :
     *                ItemLocation (enumeration)
     * @param loc_data :
     *                int designating the slot where the item is stored or
     ...
     * loc and loc_data different from database, say datas not up-to-date
     * 
     * @param price :
    ...
    /**
     * Sets the price of the item for buying <U><I>Remark :</I></U> If
     * loc and loc_data different from database, say datas not up-to-date
     * 
     * @param price :
     *                int
     ...
     *      also check constraints: only soloing castle owners may pick up
     *      mercenary tickets of their castle
     */
    @Override
    ...
    /**
     * Returns true if this item is a shadow item Shadow items have a
     * limited life-time
     * 
     * @return
     */
     ...
     * schedules a new consumption task if non is running optionally one
     * could force a new task
     * 
     * @param forces
     ...
     * <UL>
     * <LI><B>IF</B> the item has no owner, or has no location, or has a
     * null quantity : remove item from database</LI>
	...
	try
	{
		...
		{
		    item.setCrystallizable(false); // donator can't
		    // crystallize
		    // rented item
		    item.setSellable(false); // donator can's sell rented
		    // item
		    item.setDropable(false); // donator can't drop rented
		    // item
		    item.setDestroyable(false); // donator can't destroy rented
		    // item
		    item.setTradeable(false); // donator can't trade rented
		    // item
		}
     ...
     * <B><U> Actions</U> :</B><BR>
     * <BR>
     * <li>Set the x,y,z position of the L2ItemInstance dropped and update
     * its _worldregion </li>
     ...
     * <BR>
     * 
     * <FONT COLOR=#FF0000><B> <U>Caution</U> : This method DOESN'T ADD
     * the object to _allObjects of L2World </B></FONT><BR>
     * <BR>
     * 
     * <B><U> Assert </U> :</B><BR>
     * <BR>
