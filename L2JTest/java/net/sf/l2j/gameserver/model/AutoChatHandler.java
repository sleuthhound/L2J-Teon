...
public class AutoChatHandler implements SpawnListener
{
    ...
    /**
     * Registers a globally active auto chat for ALL instances of the given
     * NPC ID. <BR>
    ...
    /**
     * Registers a NON globally-active auto chat for the given NPC instance,
     * and adds to the currently assigned chat instance for this NPC ID,
     ...
     * <BR>
     * If an auto chat instance is set to be "global", all instances
     * matching the registered NPC ID will be added to that chat instance.
     */
