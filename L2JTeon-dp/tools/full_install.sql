...
DROP TABLE IF EXISTS autoanounce;
...
DROP TABLE IF EXISTS characters_ban_chat;
...
DROP TABLE IF EXISTS custom_merchant_buylists.sql;
DROP TABLE IF EXISTS custom_merchant_shopids.sql;
