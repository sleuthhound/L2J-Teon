...
public class LoginController
{
    ...
    /**
     * This is mostly to force the initialization of the Crypto
     * Implementation, avoiding it being done on runtime when its first
     * needed.<BR>
     * In short it avoids the worst-case execution time on runtime by doing
     * it on loading.
     * 
     * @param key
     ...
     * @return true if the ban was removed, false if there was no ban for
     *         this ip
     */
     ...
     *                The address to be removed from the ban list
     * @return true if the ban was removed, false if there was no ban for
     *         this ip or the address was invalid.
     */
     ...
     * {@link ScrambledKeyPair ScrambledKeyPairs} for communication with
     * Login Clients.
     * </p>
     * 
