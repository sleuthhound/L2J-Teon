...
public final class RequestSurrenderPledgeWar extends L2GameClientPacket
{
	 ...
	 * null && leader.isOnline() == 0) { player.sendMessage("Clan leader
	 * isn't online."); player.sendPacket(new ActionFailed()); return; } if
	 * (leader.isTransactionInProgress()) { SystemMessage sm = new
