...
public final class UseItem extends L2GameClientPacket
{
	...
	if (item.isEquipable())
	{
	    ...
	    /*
	     * Since c5 you can equip weapon again // Don't allow
	     * weapon/shield equipment if wearing formal wear if
	     * (activeChar.isWearingFormalWear() && (bodyPart ==
	     * L2Item.SLOT_LR_HAND || bodyPart == L2Item.SLOT_L_HAND ||
	     * bodyPart == L2Item.SLOT_R_HAND)) { SystemMessage sm = new
