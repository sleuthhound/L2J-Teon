...
public class SevenSigns
{
     ...
     * along with spawns for the Preachers of Doom and Orators of
    ...
    /**
     * Saves all Seven Signs data, both to the database and properties file
     * (if updateSettings = true). Often called to preserve data integrity
     * and synchronization with DB, in case of errors. <BR>
     * If player != null, just that player's data is updated in the
     * database, otherwise all player's data is sequentially updated.
     * 
     * @param player
     ...
     * database.<BR>
     * Primarily used when beginning a new cycle, and should otherwise never
     * be called.
     */
     ...
     * method checks to see if the player has registered before and will
     * update the database if necessary. <BR>
    ...
    /**
     * Returns the amount of ancient adena the specified player can claim,
     * if any.<BR>
     * If removeReward = true, all the ancient adena owed to them is
     * removed, then DB is updated.
     * 
     * @param player
     * @param removeReward
    ...
    /**
     * Used to add the specified player's seal stone contribution points to
     * the current total for their cabal. Returns the point score the
     * contribution was worth.
     * 
     * Each stone count <B>must be</B> broken down and specified by the
     * stone's color.
     * 
     * @param player
     * @param blueCount
    ...
    /**
     * Only really used at the beginning of a new cycle, this method resets
     * all seal-related data.
     */
    ...
    /**
     * Calculates the ownership of the three Seals of the Seven Signs, based
     * on various criterion. <BR>
     * <BR>
	...
	for (Integer currSeal : _signsDawnSealTotals.keySet())
	{
	    ...
	    /*
	     * - If a Seal was already closed or owned by the opponent and
	     * the new winner wants to assume ownership of the Seal, 35% or
	     * more of the members of the Cabal must have chosen the Seal.
	     * If they chose less than 35%, they cannot own the Seal. - If
	     * the Seal was owned by the winner in the previous Seven Signs,
	     * they can retain that seal if 10% or more members have chosen
	     * it. If they want to possess a new Seal, at least 35% of the
	     * members of the Cabal must have chosen the new Seal.
	     */
     ...
     * This runs all related tasks depending on the period that is about to
     * begin.
     * 
     * @author Tempy
     */
	...
	{
	    /*
	     * Remember the period check here refers to the period just
	     * ENDED!
	     */
