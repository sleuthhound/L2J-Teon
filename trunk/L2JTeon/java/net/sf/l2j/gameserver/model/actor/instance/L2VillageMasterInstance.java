...
public final class L2VillageMasterInstance extends L2FolkInstance
{
    ...
    public void onBypassFeedback(L2PcInstance player, String command)
    {
    	...
    	else if (command.startsWith("Subclass"))
    	{
    		...
    		{
    		case 1:/* 
    			 	* Add Subclass - Initial Avoid giving player an option to add a new sub class,
    			 	* if they have three already. 
    			 	*/
    			...
    			if ((subsAvailable != null) && !subsAvailable.isEmpty())
    			{
    				...
    				for (PlayerClass subClass : subsAvailable)
    				{
    					content.append("<a action=\"bypass -h npc_" + getObjectId() + "_Subclass 4 " 
    							+ subClass.ordinal() + "\" msg=\"1268;" + formatClassForDisplay(subClass) 
    		...
    		case 2: // Change Class - Initial
    			...
    			if (player.getSubClasses().isEmpty())
    			{
    				content.append("You can't change sub classes when you don't have a sub class to begin with.<br>" 
    						+ "<a action=\"bypass -h npc_" + getObjectId() + "_Subclass 1\">Add subclass.</a>");
    			}
    			else
    			{
    				...
    				{
    					content.append("<a action=\"bypass -h npc_" + getObjectId() + "_Subclass 5 0\">" 
    							+ CharTemplateTable.getClassNameById(baseClassId) + "</a>&nbsp;" 
    							+ "<font color=\"LEVEL\">(Base Class)</font><br><br>");
    				}
    				for (Iterator<SubClass> subList = iterSubClasses(player); subList.hasNext();)
    				{
    					...
    					{
    						content.append("<a action=\"bypass -h npc_" + getObjectId() + "_Subclass 5 " 
    		...
    		case 4: // Add Subclass - Action (Subclass 4 x[x])
    			...
    			/*
    			 * If the character is less than level 75 on any of their previously chosen classes
    			 *  then disallow them to change to their most recently added sub-class choice.
    			 */
    			...
    			{
    				player.sendMessage("Player "+player.getName()+" has performed a subclass change too fast"); 
    				return;
    			}
    			if (Olympiad.getInstance().isRegisteredInComp(player) || (player.getOlympiadGameId() > 0))
    			{
    			 ...
    			 * their unique reward items. If they both exist, remove both
    			...
    			else if (!Config.SUBCLASS_WITH_ITEM_AND_NO_QUEST && !Config.ALT_GAME_SUBCLASS_WITHOUT_QUESTS)
    			{
    		...
    		case 5: // Change Class - Action
    			 ...
    			 * their most recently added sub-class choice. Note: paramOne = classIndex
    			 */
    			if (!FloodProtector.getInstance().tryPerformAction(player.getObjectId(), FloodProtector.PROTECTED_SUBCLASS))  
    			{
    				player.sendMessage("Player "+player.getName()+" has performed a subclass change too fast"); 
    		...
    		case 6: // Change/Cancel Subclass - Choice
    			content.append("Please choose a sub class to change to. If the one you are looking for is not here, " 
    					+ "please seek out the appropriate master for that class.<br>" + "<font color=\"LEVEL\">Warning!</font> All classes and skills for this class will be removed.<br><br>");
    			subsAvailable = getAvailableSubClasses(player);
    		...
    		case 7: // Change Subclass - Action 
    			...
    			{
    				/*
    				 * This isn't good! modifySubClass() removed subclass from memory we must update 
    				 * _classIndex! Else IndexOutOfBoundsException can turn up some place down
    				 * the line along with other seemingly unrelated problems.
    				 */
    ...
    private final Set<PlayerClass> getAvailableSubClasses(L2PcInstance player)
    {
    	...
    	if (availSubs != null)
    	{
    		for (PlayerClass availSub : availSubs)
    		{
    			...
    			{
    				/* 
    				 * If the master is not human and not light elf, then remove any 
    				 * classes not of the same race as the master. 
    				 */
