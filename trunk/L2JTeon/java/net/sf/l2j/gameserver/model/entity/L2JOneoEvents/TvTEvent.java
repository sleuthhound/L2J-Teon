...
import net.sf.l2j.gameserver.model.entity.L2JOneoEvents.ChainAutomation.L2JOneoEventChainTwo;
 ...
 * It is fully automated and is a component of the L2J Oneo Event Automation
 * System.<br>
 * 
 * @author FBIagent
 */
public class TvTEvent
{
	...
	_teams[1].cleanMe();
	setState(EventState.INACTIVE);
	System.out.println("L2J Oneo TvT Event Engine has ended, and now VIP will start.");
	L2JOneoEventChainTwo.run();
	return;
    }
