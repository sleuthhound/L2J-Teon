...
public class L2Spawn
{
    ...
    /**
     * The identifier of the location area where L2NpcInstance can be
     * spwaned
     */
    ...
    /**
     * The current number of SpawnTask in progress or stand by of this
     * L2Spawn
     */
     ...
     * different L2NpcTemplate for each type of L2Spawn. Each template is
     * loaded once in the server cache memory (reduce memory use). When a
     * new instance of L2Spawn is created, server just create a link between
     * the instance and the template. This link is stored in <B>_template</B><BR>
     * <BR>
     * 
     * Each L2NpcInstance is linked to a L2Spawn that manages its spawn and
     * respawn (delay, location...). This link is stored in <B>_spawn</B>
     * of the L2NpcInstance<BR>
     * <BR>
     * 
     * <B><U> Actions</U> :</B><BR>
     * <BR>
     ...
     * </li>
     * <li>Check if respawn is possible to prevent multiple respawning
     * caused by lag </li>
     * <li>Update the current number of SpawnTask in progress or stand by
     * of this L2Spawn </li>
     * <li>Create a new SpawnTask to launch after the respawn Delay </li>
     * <BR>
     * <BR>
     * 
     * <FONT COLOR=#FF0000><B> <U>Caution</U> : A respawn is possible ONLY
     * if _doRespawn=true and _scheduledCount + _currentCount <
	...
	if (_doRespawn && (_scheduledCount + _currentCount < _maximumCount))
	{
	    ...
	    // ClientScheduler.getInstance().scheduleLow(new
	    // SpawnTask(npcId),
	    // _respawnDelay);
     ...
     * <B><U> Concept</U> :</B><BR>
     * <BR>
     * L2NpcInstance can be spawned either in a random position into a
     * location area (if Lox=0 and Locy=0), either at an exact position. The
     * heading of the L2NpcInstance can be a random heading if not defined
     * (value= -1) or an exact heading (ex : merchant...).<BR>
     * <BR>
     * 
     * <B><U> Actions for an random spawn into location area</U> : <I>(if
     * Locx=0 and Locy=0)</I></B><BR>
     * <BR>
     * <li>Get L2NpcInstance Init parameters and its generate an Identifier
     * </li>
     * <li>Call the constructor of the L2NpcInstance </li>
     * <li>Calculate the random position in the location area (if Locx=0
     * and Locy=0) or get its exact position from the L2Spawn </li>
     * <li>Set the position of the L2NpcInstance </li>
     * <li>Set the HP and MP of the L2NpcInstance to the max </li>
     * <li>Set the heading of the L2NpcInstance (random heading if not
     * defined : value=-1) </li>
     * <li>Link the L2NpcInstance to this L2Spawn </li>
     * <li>Init other values of the L2NpcInstance (ex : from its
     * L2CharTemplate for INT, STR, DEX...) and add it in the world </li>
     * <li>Lauch the action OnSpawn fo the L2NpcInstance </li>
     * <BR>
     * <BR>
     * <li>Increase the current number of L2NpcInstance managed by this
     * L2Spawn </li>
     * <BR>
     * <BR>
     * 
	...
	try
	{
	    ...
	    // Get L2NpcInstance Init parameters and its generate an
	    // Identifier
