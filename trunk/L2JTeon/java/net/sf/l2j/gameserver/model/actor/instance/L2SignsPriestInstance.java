...
public class L2SignsPriestInstance extends L2FolkInstance
{
	...
	} else if (command.startsWith("SevenSigns"))
	{
		...
		} else if (player.getClassId().level() >= 2)
		{
			 ...
			 * SevenSigns.CABAL_DAWN) { player.sendMessage("You must
			 * be a member of a castle-owning clan to join the Lords
			 * Of Dawn."); return; } }
			 */
			else
			{
			     ...
			     * certificate. If not then try to take the
			     * required amount of adena instead.
			     */
