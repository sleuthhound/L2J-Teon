...
public class L2BufferInstance extends L2FolkInstance
{
	...
	private void showManageSchemeWindow(L2PcInstance player)
	{
		...
		{
			tb.append("Here is a list of your schemes. To delete one just click on drop button. To create, fill name box and press create. "
					+"Each scheme must have different name. Name must have up to 14 chars. Spaces (\" \") are not allowed. DO NOT click on Create until you have filled quick box<br>");
			tb.append("<table>");
