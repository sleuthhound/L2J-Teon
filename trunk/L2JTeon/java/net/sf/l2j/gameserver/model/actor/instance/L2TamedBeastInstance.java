...
public final class L2TamedBeastInstance extends L2FeedableBeastInstance
{
    ...
    /**
     * Prepare and cast a skill: First smoothly prepare the beast for
     * casting, by abandoning other actions Next, call super.doCast(skill)
     * in order to actually cast the spell Finally, return to auto-following
     * the owner.
     * 
	...
	public void run()
	{
	     ...
	     * from home should be taken into consideration. Disabled for
	     * now.
	     * 
