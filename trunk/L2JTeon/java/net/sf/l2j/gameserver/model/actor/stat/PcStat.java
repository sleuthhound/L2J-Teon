...
public class PcStat extends PlayableStat
{
    ...
    /**
     * Add Experience and SP rewards to the L2PcInstance, remove its Karma
     * (if necessary) and Launch increase level task.<BR>
     * <BR>
     * 
     * <B><U> Actions </U> :</B><BR>
     * <BR>
     ...
     * <li>If the L2PcInstance increases it's level, manage the increase
     * level task (Max MP, Max MP, Recommandation, Expertise and beginner
     * skills...) </li>
     * <li>If the L2PcInstance increases it's level, send a Server->Client
     * packet UserInfo to the L2PcInstance </li>
     * <BR>
     * <BR>
     * 
     * @param addToExp
	...
	if (levelIncreased)
	{
	     ...
	     * applied to the first character that becomes level 6 and end
	     * if this character reaches level 25 or above. If the first
	     * character that becomes level 6 is deleted, the rest of the
	     * characters may not receive the new character bonus If the
	     * first character to become level 6 loses a level, and the
	     * player makes another character level 6, the bonus will be
	     * applied to only the first character to achieve level 6. If
	     * the character loses a level after reaching level 25, the
	     * character may not receive the bonus.
	     */
