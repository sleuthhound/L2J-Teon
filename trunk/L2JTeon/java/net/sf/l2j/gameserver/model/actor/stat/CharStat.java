...
public class CharStat
{
	...
	/**
	 * http://l2p.bravehost.com/wildmagic.html DISCLAIMER: I do not condone the accuracy of this calculator. It's here to be tested and criticized. I make no promises. In fact, this calculator doesn't exist and you never saw it. INIT PERCENT IS 10 (1% OF 1000) Return the Magic Critical Hit rate (base+modifier) of the L2Character.
	 */
