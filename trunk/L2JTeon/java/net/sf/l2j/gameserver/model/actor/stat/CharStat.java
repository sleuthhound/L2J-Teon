...
public class CharStat
{
    ...
    // Method - Public
    /**
     * Calculate the new value of the state with modifiers that will be
     * applied on the targeted L2Character.<BR>
     * <BR>
     * 
     * <B><U> Concept</U> :</B><BR>
     * <BR>
     ...
     * function is called according to its priority <B>_order</B>. Indeed,
     * Func with lowest priority order is executed firsta and Funcs with the
     * same order are executed in unspecified order. The result of the
     ...
     * @param init
     *                The initial value of the stat before applying
     *                modifiers
     * @param target
     *                The L2Charcater whose properties will be used in the
     *                calculation (ex : CON, INT...)
     * @param skill
     *                The L2Skill whose properties will be used in the
     *                calculation (ex : Level...)
     * 
     */
    ...
    // Property - Public
    /**
     * Return the Accuracy (base+modifier) of the L2Character in function of
     * the Weapon Expertise Penalty.
     */
    ...
    /**
     * Return the Attack Speed multiplier (base+modifier) of the L2Character
     * to get proper animations.
     */
	...
	// Set a cap of Critical Hit at defined value in
	// L2JOneoCustom.properties
    ...
    /**
     * Return the MAtk (base+modifier) of the L2Character for a skill used
     * in function of abnormal effects in progress.<BR>
     * <BR>
     * 
    ...
    /**
     * Return the MAtk Speed (base+modifier) of the L2Character in function
     * of the Armour Expertise Penalty.
     */
    ...
    /**
     * http://l2p.bravehost.com/wildmagic.html DISCLAIMER: I do not condone
     * the accuracy of this calculator. It's here to be tested and
     * criticized. I make no promises. In fact, this calculator doesn't
     * exist and you never saw it.
     * 
     * INIT PERCENT IS 10 (1% OF 1000)
     * 
     * Return the Magic Critical Hit rate (base+modifier) of the
     * L2Character.
     */
    public final int getMCriticalHit(L2Character target, L2Skill skill)
    {
	double mrate = calcStat(Stats.MCRITICAL_RATE, 10, target, skill);
	return (int) mrate;
    }
    ...
    /**
     * Return the RunSpeed (base+modifier) or WalkSpeed (base+modifier) of
     * the L2Character in function of the movement type.
     */
	...
	/**
     * Return the PAtk Speed (base+modifier) of the L2Character in function
     * of the Armour Expertise Penalty.
     */
    ...
    /**
     * Return the RunSpeed (base+modifier) of the L2Character in function of
	...
	// Added running speed configuration option.
