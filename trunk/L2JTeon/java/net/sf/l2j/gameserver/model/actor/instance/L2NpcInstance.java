 ...
 * values. The templates are hardcoded in the client, so we can rely on them.<BR>
 * <BR>
 *
 * L2Character :<BR>
 * <BR>
...
public class L2NpcInstance extends L2Character
{
    ...
    /**
     * The castle index in the array of L2Castle this L2NpcInstance belongs
     * to
     */
    private int _castleIndex = -2;
    private int _fortIndex = -2;
    public boolean isEventMob = false, _isEventVIPNPC = false,
	...
	public void run()
	{
		...
		if (this != _rAniTask)
		{
		    return; // Shouldn't happen, but who knows... just to
		    // make
     ...
     * of the L2NpcInstance and create a new RandomAnimation Task.<BR>
     * <BR>
     */
     ...
     * L2Character (copy skills from template to object and link
     ...
     * <B><U> Concept</U> :</B><BR>
     * <BR>
     * If a NPC belows to a Faction, other NPC of the faction inside the
     * Faction range will help it if it's attacked<BR>
     * <BR>
     *
     */
    ...
    /**
     * Return true if the L2NpcInstance is agressive (ex : L2MonsterInstance
     * in function of aggroRange).<BR>
     * <BR>
     */
    ...
    /**
     * Send a packet NpcInfo with state of abnormal effect to all
     * L2PcInstance in the _KnownPlayers of the L2NpcInstance.<BR>
     * <BR>
     */
    @Override
    ...
    /**
     * Return the distance under which the object must be add to
    ...
    /**
     * Return the Identifier of the item in the left hand of this
     * L2NpcInstance contained in the L2NpcTemplate.<BR>
     * <BR>
     */
     ...
     * necessary)</li>
     * <li>Send a Server->Client packet MyTargetSelected to the
     * L2PcInstance player (display the select window)</li>
     * <li>If L2NpcInstance is autoAttackable, send a Server->Client packet
     * StatusUpdate to the L2PcInstance in order to update L2NpcInstance HP
     * bar </li>
     * <li>Send a Server->Client packet ValidateLocation to correct the
     * L2NpcInstance position and heading on the client </li>
     * <BR>
     * <BR>
     *
     * <B><U> Actions on second click on the L2NpcInstance (Attack
     * it/Intercat with it)</U> :</B><BR>
     * <BR>
     * <li>Send a Server->Client packet MyTargetSelected to the
     * L2PcInstance player (display the select window)</li>
     * <li>If L2NpcInstance is autoAttackable, notify the L2PcInstance AI
     * with AI_INTENTION_ATTACK (after a height verification)</li>
     * <li>If L2NpcInstance is NOT autoAttackable, notify the L2PcInstance
     * AI with AI_INTENTION_INTERACT (after a distance verification) and
     * show message</li>
     * <BR>
     * <BR>
     *
     * <FONT COLOR=#FF0000><B> <U>Caution</U> : Each group of
     * Server->Client packet must be terminated by a ActionFailed packet in
     ...
     * <B><U> Overriden in </U> :</B><BR>
     * <BR>
     * <li> L2ArtefactInstance : Manage only fisrt click to select Artefact</li>
     * <BR>
     * <BR>
     * <li> L2GuardInstance : </li>
     * <BR>
     * <BR>
     *
     * @param player
     ...
     *
     * @param client
     *                The thread that manage the player that pessed Shift
    ...
    /**
     * Open a quest or chat window on client with the text of the
     * L2NpcInstance in function of the command.<BR>
     * <BR>
     *
     * <B><U> Example of use </U> :</B><BR>
     * <BR>
	...
	//if (canInteract(player))
	{
		...
		try
		{
		    ...
		    /*
		     * if (player.getCoupon(0) || !player.isNewbie()) {
		     * html.setFile("data/html/adventurers_guide/31760-1.htm");
		     * player.sendPacket(html); } else
		     */{
    ...
    /**
     * Return the weapon item equiped in the right hand of the L2NpcInstance
     * or null.<BR>
     * <BR>
     */
    @Override
    ...
    /**
     * Return the weapon item equiped in the left hand of the L2NpcInstance
     * or null.<BR>
     * <BR>
     */
    @Override
     ...
     * order to display the message of the L2NpcInstance.<BR>
     * <BR>
     *
     * @param player
     ...
     * npcId and of the page number.<BR>
     * <BR>
     *
     ...
     * <B><U> Overriden in </U> :</B><BR>
     * <BR>
     * <li> L2GuardInstance : Set the pathfile to
     * data/html/guard/12006-1.htm (npcId-page number)</li>
     * <BR>
     * <BR>
     *
     * @param npcId
     *                The Identifier of the L2NpcInstance whose text must be
     *                display
     * @param val
     ...
     * <B><U> Actions</U> :</B><BR>
     * <BR>
     * <li>Get the text of the selected HTML file in function of the npcId
     * and of the page number </li>
     * <li>Send a Server->Client NpcHtmlMessage containing the text of the
     * L2NpcInstance to the L2PcInstance </li>
     * <li>Send a Server->Client ActionFailed to the L2PcInstance in order
     * to avoid that the client wait another packet </li>
     * <BR>
     *
     * @param player
     *                The L2PcInstance that talk with the L2NpcInstance
     ...
     * <li>If player level is out of range, display a message and return
     * </li>
     * <li>According to player level cast buff </li>
     * <BR>
     * <BR>
     *
     * <FONT COLOR=#FF0000><B> Newbie Helper Buff list is define in sql
     * table helper_buff_list</B></FONT><BR>
     * <BR>
     *
     * @param player
     *                The L2PcInstance that talk with the L2NpcInstance
	...
	if ((player_level > highestLevel) || !player.isNewbie())
	{
    ...
    /**
     * Open a chat window on client with the text specified by the given
    ...
    /**
     * Return the SP Reward of this L2NpcInstance contained in the
     * L2NpcTemplate (modified by RATE_SP).<BR>
     * <BR>
     */
     ...
     * (for a complete removal use the deleteMe method).<BR>
     * <BR>
     *
     * <B><U> Actions</U> :</B><BR>
     * <BR>
     ...
     * <B><U> Actions</U> :</B><BR>
     * <BR>
     * <li>Remove the L2NpcInstance from the world and update its spawn
     * object </li>
