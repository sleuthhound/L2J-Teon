 ...
 */
/**
 * This is the VIP engine which is called upon by the VIPTask class which is further called upon by the L2JOneoEventManager class. <br>
 * It is fully automated and is a component of the L2JOneo Event Automation System.<br>
 * 
 * @author Ahmed
 */
package net.sf.l2j.gameserver.model.entity.L2JOneoEvents;
...
import net.sf.l2j.gameserver.model.entity.L2JOneoEvents.ChainAutomation.L2JOneoEventManager;
...
public class VIP
{
    ...
    public static int _time = Config.VIP_LASTING_TIME, _winners = 0,
	    _endNPC = Config.VIP_FINISH_NPC_ID,
	    _delay = Config.VIP_PARTICIPATION_TO_START_DELAY, _endX = 0,
	    _endY = 0, _endZ = 0, _startX = 0, _startY = 0, _startZ = 0,
	    _tpbackX = Config.VIP_TP_LOC_X, _tpbackY = Config.VIP_TP_LOC_Y,
	    _tpbackZ = Config.VIP_TP_LOC_Z, _team = 0; // Human = 1
    // Elf = 2
    // Dark = 3
    // Orc = 4
    // Dwarf = 5
    public static boolean _started = false, _joining = false,
	    _sitForced = Config.VIP_FORCE_SIT;
    ...
    /**
     * When this is called players can type .joinvip and be entered into the
     * event. Also Random Race is selected as the VIP team.
     */
    ...
    /**
     * This is called if not enough players on VIP team or Non VIP team.,
     * <br>
     ...
     * players teleported back, and announcement to all players, deletion of
     * the event npc.<br>
     */
    ...
    /**
     * his is the message players will get when they talk to the VIP Finish
     * NPC.
     * 
     * @param eventPlayer
     * @param objectId
    ...
    /**
     * This is called if the VIP wins the Event by talking to the VIP Finish
     * NPC, <br>
     * he and his team get rewarded. <br>
     * Announcement to all players, and deletion of all VIP npc's and
     * teleport back to area set by config files. <br>
     */
    ...
    /**
     * This makes the calls to teleport players back to town if the event
     * ends, the finish location is set in properties files.
     */
    ...
    /**
     * This randomly selects the VIP player from the team selected as the
     * VIP team.
     */
    ...
    /**
     * This calls for setting the Players name colors depending on their
     * team and role.
     */
