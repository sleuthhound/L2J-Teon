...
public class L2FestivalMonsterInstance extends L2MonsterInstance
{
     ...
     * L2FestivalMonsterInstance (copy skills from template to object and
     * link _calculators to NPC_STD_CALCULATOR) </li>
    ...
    /**
     * Actions:
     * <li>Check if the killing object is a player, and then find the party
     * they belong to.</li>
