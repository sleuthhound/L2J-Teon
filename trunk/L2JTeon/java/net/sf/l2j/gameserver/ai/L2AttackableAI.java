...
public class L2AttackableAI extends L2CharacterAI implements Runnable
{
     ...
     * <li>The target isn't dead, isn't invulnerable, isn't in silent
     * moving mode AND too far (>100)</li>
    ...
    /**
     * Set the Intention of this L2CharacterAI and create an AI Task
     * executed every 1s (call onEvtThink method) for this L2Attackable.<BR>
     * <BR>
     * 
     ...
     * <li>If the actor is Aggressive and can attack, add all
     * autoAttackable L2Character in its Aggro Range to its _aggroList,
     * chose a target and order to attack it</li>
     * <li>If the actor is a L2GuardInstance that can't attack, order to it
     * to return to its home location</li>
     * <li>If the actor is a L2MonsterInstance that can't attack, order to
     * it to random walk (1/100)</li>
     * <BR>
     * <BR>
     * 
     */
     ...
     * <li>If target is dead or timeout is expired, stop this attack and
     * set the Intention to AI_INTENTION_ACTIVE</li>
     * <li>Call all L2Object of its Faction inside the Faction Range</li>
     * <li>Chose a target and order to attack it with magic skill or
     * physical attack</li>
     * <BR>
     * <BR>
     * 
     ...
     * <B><U> Actions</U> :</B><BR>
     * <BR>
     * <li>Init the attack : Calculate the attack timeout, Set the
     * _globalAggro to 0, Add the attacker to the actor _aggroList</li>
     ...
     * L2GuardInstance check if it isn't too far from its home location)</li>
     * <BR>
     * <BR>
     * 
     * @param attacker
     ...
     * @param aggro
     *                The value of hate to add to the actor against the
     *                target
     * 
     */
    @Override
