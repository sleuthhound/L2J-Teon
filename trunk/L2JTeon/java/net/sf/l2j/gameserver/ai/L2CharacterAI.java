...
public class L2CharacterAI extends AbstractAI
{
     ...
     * Start a new Attack and Launch Think Event.<BR>
     * <BR>
     * 
     * <B><U> Actions</U> : </B><BR>
     * <BR>
     ...
     * <li>Start the actor Auto Attack client side by sending
     * Server->Client packet AutoAttackStart (broadcast) </li>
     * <li>Launch the Think Event </li>
     * <BR>
     * <BR>
     * 
    ...
    /**
     * Manage the Cast Intention : Stop current Attack, Init the AI in order
     * to cast and Launch Think Event.<BR>
     * <BR>
     * 
     * <B><U> Actions</U> : </B><BR>
     * <BR>
    ...
    /**
     * Manage the Move To Intention : Stop current Attack and Launch a Move
     * to Location Task.<BR>
     * <BR>
     * 
     * <B><U> Actions</U> : </B><BR>
     * <BR>
     * <li>Stop the actor auto-attack server side AND client side by
     * sending Server->Client packet AutoAttackStop (broadcast) </li>
     * <li>Set the Intention of this AI to AI_INTENTION_MOVE_TO </li>
     * <li>Move the actor to Location (x,y,z) server side AND client side
     * by sending Server->Client packet CharMoveToLocation (broadcast) </li>
     * <BR>
     * <BR>
     * 
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.sf.l2j.gameserver.ai.AbstractAI#onIntentionMoveToInABoat(net.sf.l2j.gameserver.model.L2CharPosition,
    ...
    /**
     * Manage the PickUp Intention : Set the pick up target and Launch a
     * Move To Pawn Task (offset=20).<BR>
     * <BR>
     * 
     * <B><U> Actions</U> : </B><BR>
     * <BR>
    ...
    /**
     * Manage the Interact Intention : Set the interact target and Launch a
     * Move To Pawn Task (offset=60).<BR>
     * <BR>
     * 
     * <B><U> Actions</U> : </B><BR>
     * <BR>
     ...
     * <li>Stop the actor movement server side AND client side by sending
     * Server->Client packet StopMove/StopRotation (broadcast)</li>
     * <li>Break an attack and send Server->Client ActionFailed packet and
     * a System Message to the L2Character </li>
     * <li>Break a cast and send Server->Client ActionFailed packet and a
     ...
     * AI_INTENTION_ACTIVE</li>
     * <li>If the object was targeted to attack, stop the auto-attack,
     * cancel target and set the Intention to AI_INTENTION_ACTIVE</li>
     * <li>If the object was targeted to cast, cancel target and set the
     * Intention to AI_INTENTION_ACTIVE</li>
     * <li>If the object was targeted to follow, stop the movement, cancel
     * AI Follow Task and set the Intention to AI_INTENTION_ACTIVE</li>
     * <li>If the targeted object was the actor , cancel AI target, stop AI
     * Follow Task, stop the movement and set the Intention to
     * AI_INTENTION_IDLE </li>
     * <BR>
     * <BR>
     * 
     */
     ...
     * <B><U> Actions</U> :</B><BR>
     * <BR>
     * <li>Get the distance between the current position of the L2Character
     * and the target (x,y)</li>
     * <li>If the distance > offset+20, move the actor (by running) to Pawn
     * server side AND client side by sending Server->Client packet
     * MoveToPawn (broadcast)</li>
     * <li>If the distance <= offset+20, Stop the actor movement server
     * side AND client side by sending Server->Client packet
     * StopMove/StopRotation (broadcast)</li>
     * <BR>
     * <BR>
     * 
	...
	if (!_actor.isInsideRadius(target, offset, false, false))
	{
	    ...
	    // If not running, set the L2Character movement type to run and
	    // send
	...
	{
	    L2PcInstance target2 = (L2PcInstance) target; // convert
	    // object to
	    // chara
