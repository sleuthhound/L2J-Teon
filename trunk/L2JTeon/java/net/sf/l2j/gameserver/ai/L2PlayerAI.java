...
public class L2PlayerAI extends L2CharacterAI
{
    ...
    /**
     * Saves the current Intention for this L2PlayerAI if necessary and
     * calls changeIntention in AbstractAI.<BR>
     * <BR>
     * 
     * @param intention
     ...
     * <BR>
     * 
     * <B>What it does:</B> Check if actual intention is set to CAST and,
     * if so, retrieves latest intention before the actual CAST and set it
     * as the current intention for the player
     */
    @Override
