 ...
 * Items are defined in the table <B>allNpcDateDrops</B>. Each Special Event
 * has a start and end date to stop to drop extra Items automaticaly.<BR>
 * <BR>
 */
public class EventDroplist
{
     ...
     * 
     * @param items
     *                The table containing all item identifier of this
     *                DateDrop
     * @param count
     *                The table containing min and max value of this
     *                DateDrop
     * @param chance
