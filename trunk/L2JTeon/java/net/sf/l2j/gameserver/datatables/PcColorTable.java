...
public class PcColorTable
{
    ...
    /**
     * Returns the instance of this class, assign a new object to _instance
     * if it's null
     * 
     * @return PcColorTable
     */
    ...
    /**
     * Returns true if the name is deleted successfully from list, otherwise
     * false Deletes the name from the list
     * 
     * @param charName
     * @return boolean
     */
