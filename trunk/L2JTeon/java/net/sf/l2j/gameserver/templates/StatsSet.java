...
public final class StatsSet
{
     ...
     * 
     * @param newSet :
     *                StatsSet pointing out the list of couples to add in
     *                the current set
     */
    ...
    /**
     * Return the boolean associated to the key put in parameter ("name").
     * If the value associated to the key is null, this method returns the
     * value of the parameter deflt.
     * 
     * @param name :
     *                String designating the key in the set
     * @param deflt :
     *                boolean designating the default value if value
     *                associated with the key is null
    ...
    /**
     * Returns the int associated to the key put in parameter ("name"). If
     * the value associated to the key is null, this method returns the
     * value of the parameter deflt.
     * 
     * @param name :
     *                String designating the key in the set
     * @param deflt :
     *                byte designating the default value if value associated
    ...
    /**
     * Returns the short associated to the key put in parameter ("name"). If
     * the value associated to the key is null, this method returns the
     * value of the parameter deflt.
     * 
     * @param name :
     *                String designating the key in the set
     * @param deflt :
     *                short designating the default value if value
     *                associated with the key is null
     ...
     *                String designating the key in the set
     * @param deflt :
     *                int designating the default value if value associated
     *                with the key is null
     * @return int : value associated to the key
     */
    ...
    /**
     * Returns the long associated to the key put in parameter ("name"). If
     * the value associated to the key is null, this method returns the
     * value of the parameter deflt.
     * 
     * @param name :
     *                String designating the key in the set
     * @param deflt :
     *                long designating the default value if value associated
     *                with the key is null
     * @return long : value associated to the key
     */
    ...
    /**
     * Returns the float associated to the key put in parameter ("name"). If
     * the value associated to the key is null, this method returns the
     * value of the parameter deflt.
     * 
     * @param name :
     *                String designating the key in the set
     * @param deflt :
     *                float designating the default value if value
     *                associated with the key is null
     * @return float : value associated to the key
     */
     ...
     *                String designating the key in the set
     * @param deflt :
     *                String designating the default value if value
     *                associated with the key is null
     * @return String : value associated to the key
     */
     ...
     *                String designating the key in the set
     * @param enumClass :
     *                Class designating the class of the value associated
     *                with the key in the set
     * @return Enum<T>
     */
    ...
    /**
     * Returns an enumeration of &lt;T&gt; from the set. If the enumeration
     * is empty, the method returns the value of the parameter "deflt".
     * 
     * @param <T> :
     *                Class of the enumeration returned
     * @param name :
     ...
     *                String designating the key in the set
     * @param value :
     *                String corresponding to the value associated with the
     *                key
     */
     ...
     *                String designating the key in the set
     * @param value :
     *                boolean corresponding to the value associated with the
     *                key
     */
     ...
     *                String designating the key in the set
     * @param value :
     *                double corresponding to the value associated with the
     *                key
     */
     ...
     *                String designating the key in the set
     * @param value :
     *                Enum corresponding to the value associated with the
     *                key
     */
    @SuppressWarnings("unchecked")
