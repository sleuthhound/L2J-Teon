...
public class IRCUtil implements IRCConstants
{
    ...
    // ------------------------------
    /**
     * This is an empty constructor, it does nothing. Nobody may instantiate
     * this class.
     */
    private IRCUtil()
    {
    ...
    // ------------------------------
    /**
     * According to RFC2812 the channel's name may and must start with one
     ...
     * @return <code>true</code> if the argument starts with one of the
    ...
    // ------------------------------
    /**
     * Erases the mIRC colorcodes from a String. The documentation of the
     * evil color codes is available on <a
     * href="http://www.mirc.co.uk/help/color.txt"
     * target="_blank">http://www.mirc.co.uk/help/color.txt</a>. This
     * method links to the <code>parseColors(StringBuffer)</code> method.
     * 
     * @param str
     ...
     * @param buf
     *                The line which should be parsed.
     * @return A line as <code>StringBuffer</code> object which is cleaned
     *         from any mIRC colorcodes.
     ...
     *                <code>' '</code>.
     * @param trailing
     *                The ending which is added as a substring though it
     *                wasn't in the <code>str</code>. This parameter is
     *                just for the <code>IRCParser</code> class which uses
     *                this method to split the <code>middle</code> part
     *                into the parameters. But as last parameter always the
     *                <code>trailing</code> is added. This is done here
     *                because it's the fastest way to do it here. <br />
