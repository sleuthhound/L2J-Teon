...
public class FortResistSiegeManager extends ClanHallSiege
{
	...
	/*
	 * private int[][][] _guardSpawnLoc = { { { 35369, 44505, 108867, -2020, 33380 }, { 35369, 44545, 108867, -2020, 32768 }, { 35370, 44485, 108867, -2020, 49277 }, { 35370, 44525, 108827, -2020, 49277 }, { 35370, 44535, 108895, -2020, 49277 }, { 35370, 44553, 108839, -2020, 49277 }, { 35370, 44553, 108895, -2020, 49277 }, { 35370, 44565, 108867, -2020, 49277 }, { 35371, 44515, 108850, -2020,
	 * 49277 }, { 35371, 44515, 108884, -2020, 49277 }, { 35371, 44535, 108850, -2020, 49277 }, { 35373, 44788, 109492, -1705, 49277 }, { 35373, 44788, 109492, -1705, 49277 }, { 35373, 45168, 109020, -1705, 49277 }, { 35374, 44812, 109492, -1705, 49277 }, { 35374, 45236, 108980, -1705, 49277 }, { 35370, 44497, 108839, -2020, 49317 } }, };
	 */
...
/*
 * public void initLocationGuardSpawns() { int locNo = Rnd.get(4); final int[] Nurka = { 35368 }; L2Spawn spawnDat; L2NpcTemplate template; _guardSpawns.clear(); for (int i = 0; i <= 3; i++) { template = NpcTable.getInstance().getTemplate(_guardSpawnLoc[locNo][i][0]); if (template != null) { try { spawnDat = new L2Spawn(template); spawnDat.setAmount(1);
 * spawnDat.setLocx(_guardSpawnLoc[locNo][i][1]); spawnDat.setLocy(_guardSpawnLoc[locNo][i][2]); spawnDat.setLocz(_guardSpawnLoc[locNo][i][3]); spawnDat.setHeading(_guardSpawnLoc[locNo][i][4]); SpawnTable.getInstance().addNewSpawn(spawnDat, false); int NpcId = Nurka[i]; _guardSpawns.put(NpcId, spawnDat); } catch (Exception e) { } } } } public void locationGuardSpawns() { int locNo = Rnd.get(4);
 * final int[] Nurka = { 35368 }; L2Spawn spawnDat; for (int i = 0; i <= 3; i++) { int NpcId = Nurka[i]; spawnDat = _guardSpawns.get(NpcId); spawnDat.setLocx(_guardSpawnLoc[locNo][i][1]); spawnDat.setLocy(_guardSpawnLoc[locNo][i][2]); spawnDat.setLocz(_guardSpawnLoc[locNo][i][3]); spawnDat.setHeading(_guardSpawnLoc[locNo][i][4]); _guardSpawns.put(NpcId, spawnDat); } } public void spawnGuard(int
 * npcId) { if (!isAttackTime()) return; L2Spawn spawnDat = _guardSpawns.get(npcId); if (spawnDat != null) { L2SiegeMonsterInstance mob = (L2SiegeMonsterInstance) spawnDat.doSpawn(); spawnDat.stopRespawn(); } }
 */
