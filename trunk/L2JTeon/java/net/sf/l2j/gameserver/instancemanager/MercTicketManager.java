...
public class MercTicketManager
{
    ...
    /**
     * Checks if the passed item belongs to a castle which has reached its
     * limit of number of dropped tickets.
     */
    ...
    /**
     * addTicket actions 1) find the npc that needs to be saved in the
     * mercenary spawns, given this item 2) Use the passed character's
     * location info to add the spawn 3) create a copy of the item to drop
     * in the world returns the id of the mercenary npc that was added to
     * the spawn returns -1 if this fails.
     */
    ...
    /**
     * remove a single ticket and its associated spawn from the world (used
     * when the castle lord picks up a ticket, for example)
     */
