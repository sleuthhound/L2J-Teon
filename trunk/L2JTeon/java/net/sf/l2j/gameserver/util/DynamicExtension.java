...
public class DynamicExtension
{
    ...
    /**
     * create an instance of DynamicExtension this will be done by
     * GameServer according to the altsettings.properties
     * 
     */
     ...
     * 
     * @param name
     *                the class name and optionally a jar file name
     *                delimited with a '@' if the jar file is not in the
     *                class path
     */
    ...
    /**
     * create a new class loader which resets the cache (jar files and
     * loaded classes) on next class loading request it will read the jar
     * again
     */
    ...
    /**
     * unloads all extensions, resets the cache and initializes all
    ...
    /**
     * unloads a named extension, resets the cache and initializes the
     * extension
     * 
     * @param name
     *                the class name and optionally a jar file name
