...
public class MercTicket implements IItemHandler
{
     ...
     * constraints: 1.a) Tickets may only be used in a castle 1.b) Only
     * specific tickets may be used in each castle (different tickets for
     * each castle) 1.c) only the owner of that castle may use them 1.d)
     * tickets cannot be used during siege 1.e) Check if max number of
     * tickets has been reached 1.f) Check if max number of tickets from
     * this ticket's TYPE has been reached 2) If allowed, call the
     * MercTicketManager to add the item and spawn in the world 3) Remove
     * the item from the person's inventory
     */
