 ...
 * ban on the specified player. - admin_unbanchat = Removes any chat ban on the
 * specified player.
 * 
 * Uses: admin_banchat [<player_name>] [<time_in_seconds>] admin_banchat [<player_name>] [<time_in_seconds>] [<ban_chat_reason>]
