...
/**
 * @author evill33t reworked schursin (L2JOneo Dev Team)
 */
public class Wedding implements IVoicedCommandHandler
{
	...
	if (playerA.getPartnerId() == 0)
	{
	    _log.error("Married but couldn't find parter for " + playerA.getName());
	    playerA.sendMessage("Our records cannot find your fiance in the database. Please inform a GameMaster about this promptly.");
	    return false;
	}
	// try to found partner
	L2PcInstance playerB = (L2PcInstance) L2World.getInstance().findObject(playerA.getPartnerId());
