...
public class Base64
{
     ...
     * of significant bytes in your array is given by <var>numSigBytes</var>.
     * The array <var>threeBytes</var> needs only be as big as
     ...
     * the resulting four Base64 bytes to <var>destination</var>. The
     ...
     * to accomodate <var>srcOffset</var> + 3 for the <var>source</var>
     * array or <var>destOffset</var> + 4 for the <var>destination</var>
     * array. The actual number of significant bytes in your array is given
     ...
     * another error, the method will return <tt>null</tt>. The object is
     * not GZip-compressed before being encoded.
     * 
     ...
     * byte array. Does not support automatically gunzipping or any other
     * "fancy" features.
     * 
     * @param source
     ...
     * {@link java.io.InputStream}, given in the constructor, and
	 ...
	 * 
	 * @param in
	 *                the {@link java.io.InputStream} from which to read
	 *                data.
	 * @since 1.3
	 */
