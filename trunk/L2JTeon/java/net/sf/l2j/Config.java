...
public final class Config {
	protected static final Logger _log = Logger.getLogger(Config.class
			.getName());
	/** Configuration files */
	...
	public static final FloodProtectorConfig FLOOD_PROTECTOR_USE_ITEM = new FloodProtectorConfig(
			"UseItemFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_ROLL_DICE = new FloodProtectorConfig(
			"RollDiceFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_FIREWORK = new FloodProtectorConfig(
			"FireworkFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_ITEM_PET_SUMMON = new FloodProtectorConfig(
			"ItemPetSummonFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_HERO_VOICE = new FloodProtectorConfig(
			"HeroVoiceFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_SUBCLASS = new FloodProtectorConfig(
			"SubclassFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_DROP_ITEM = new FloodProtectorConfig(
			"DropItemFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_SERVER_BYPASS = new FloodProtectorConfig(
			"ServerBypassFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_UNK_PACKETS = new FloodProtectorConfig(
			"UnkPacketsFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_BUFFER = new FloodProtectorConfig(
			"BufferFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_CRAFT = new FloodProtectorConfig(
			"CraftFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_MULTISELL = new FloodProtectorConfig(
			"MultiSellFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_BANKING_SYSTEM = new FloodProtectorConfig(
			"BankingSystemFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_WEREHOUSE = new FloodProtectorConfig(
			"WerehouseFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_MISC = new FloodProtectorConfig(
			"MiscFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_CHAT = new FloodProtectorConfig(
			"ChatFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_GLOBAL = new FloodProtectorConfig(
			"GlobalFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_TRADE = new FloodProtectorConfig(
			"TradeFloodProtector");
	public static final FloodProtectorConfig FLOOD_PROTECTOR_POTION = new FloodProtectorConfig(
			"PotionFloodProtector");
	 ...
	 * Objects. <br> This may help servers with large amounts of players
	 * recieving error messages related to the <i>IdFactoryType</i> and
	 * <i>L2ObjectHashMap</i> and <i>L2ObejctHashSet</i> classes.
	 */
	...
	/*
	 * Allow lottery, race, water, Fishing, rent pet, boat, cursed weapons and
	 * freight ?
	 */
	...
	/**
	 * Config option allowing server administrators/owners the ability to set a
	 * title for new players.
	 */
	...
	/**
	 * Configuration for an Admin to disallow subclassers to get max level 80
	 * through the SetHighLevelOnStart
	 */
	...
	/**
	 * This allows the administrator to set up additional items for players to
	 * start off with, items are put in the format: id,count;id,count;id,count
	 */
	...
	/**
	 * Config option to either allow or disallow a player getting petrified by a
	 * raidboss, due to the 8+ level difference rule.
	 */
	...
	/**
	 * Allows clan leaders the power allow clan members withdraw items from clan
	 * warehouse.
	 */
	...
	/**
	 * After entering the room, this is the wait time before mobs will spawn in
	 * the room. (in ms, 1 second = 1000 ms)
	 */
	 ...
	 * coordinates of ALL characters making them all at the same spawn point.
	 */
	...
	/**
	 * Configure the amount of Adena to trade for the below configured number of
	 * Gold Bars.
	 */
	...
	public static void load() {
		if (Server.serverMode == Server.MODE_GAMESERVER) {
			...
			try {
				...
				PORT_GAME = Integer.parseInt(serverSettings.getProperty(
						"GameserverPort", "7777"));
				...
				DATABASE_IDLECONNECTIONTEST = Integer.parseInt(serverSettings
						.getProperty("IdleConnectionTest", "10800"));
				...
				CNAME_TEMPLATE = serverSettings.getProperty("CnameTemplate",
						".*");
				PET_NAME_TEMPLATE = serverSettings.getProperty(
						"PetNameTemplate", ".*");
				MAX_CHARACTERS_NUMBER_PER_ACCOUNT = Integer
						.parseInt(serverSettings.getProperty("CharMaxNumber",
								"0"));
				...
				ENABLE_PACKET_PROTECTION = Boolean.parseBoolean(serverSettings
						.getProperty("PacketProtection", "True"));
				MAX_UNKNOWN_PACKETS = Integer.parseInt(serverSettings
						.getProperty("UnknownPacketsBeforeBan", "5"));
				UNKNOWN_PACKETS_PUNISHMENT = Integer.parseInt(serverSettings
						.getProperty("UnknownPacketsPunishment", "2"));
				...
				DATABASE_AUTO_OPTIMIZE = Boolean.parseBoolean(serverSettings
						.getProperty("DatabaseAutoOptimize", "False"));
			...
			try {
				...
				altSettings.load(is);
				is.close();
				ALT_GAME_TIREDNESS = Boolean.parseBoolean(altSettings
						.getProperty("AltGameTiredness", "False"));
				SOUL_CRYSTAL_BREAK_CHANCE = Integer.parseInt(altSettings
						.getProperty("SoulCrystalBreakChance", "10"));
				SOUL_CRYSTAL_LEVEL_CHANCE = Integer.parseInt(altSettings
						.getProperty("SoulCrystalLevelChance", "32"));
				ALT_GAME_CREATION = Boolean.parseBoolean(altSettings
						.getProperty("AltGameCreation", "False"));
				ALT_GAME_CREATION_SPEED = Double.parseDouble(altSettings
						.getProperty("AltGameCreationSpeed", "1"));
				ALT_GAME_CREATION_XP_RATE = Double.parseDouble(altSettings
						.getProperty("AltGameCreationRateXp", "1"));
				ALT_GAME_CREATION_SP_RATE = Double.parseDouble(altSettings
						.getProperty("AltGameCreationRateSp", "1"));
				ALT_BLACKSMITH_USE_RECIPES = Boolean.parseBoolean(altSettings
						.getProperty("AltBlacksmithUseRecipes", "True"));
				ALT_MAGES_PHYSICAL_DAMAGE_MULTI = Float.parseFloat(altSettings
						.getProperty("AltPDamageMages", "1.00"));
				ALT_MAGES_MAGICAL_DAMAGE_MULTI = Float.parseFloat(altSettings
						.getProperty("AltMDamageMages", "1.00"));
				ALT_FIGHTERS_PHYSICAL_DAMAGE_MULTI = Float
						.parseFloat(altSettings.getProperty(
								"AltPDamageFighters", "1.00"));
				ALT_FIGHTERS_MAGICAL_DAMAGE_MULTI = Float
						.parseFloat(altSettings.getProperty(
								"AltMDamageFighters", "1.00"));
				ALT_PETS_PHYSICAL_DAMAGE_MULTI = Float.parseFloat(altSettings
						.getProperty("AltPDamagePets", "1.00"));
				ALT_PETS_MAGICAL_DAMAGE_MULTI = Float.parseFloat(altSettings
						.getProperty("AltMDamagePets", "1.00"));
				ALT_NPC_PHYSICAL_DAMAGE_MULTI = Float.parseFloat(altSettings
						.getProperty("AltPDamageNpc", "1.00"));
				ALT_NPC_MAGICAL_DAMAGE_MULTI = Float.parseFloat(altSettings
						.getProperty("AltMDamageNpc", "1.00"));
				ALT_GAME_SKILL_LEARN = Boolean.parseBoolean(altSettings
						.getProperty("AltGameSkillLearn", "False"));
				AUTO_LEARN_SKILLS = Boolean.parseBoolean(altSettings
						.getProperty("AutoLearnSkills", "False"));
				ALT_GAME_CANCEL_BOW = altSettings.getProperty(
						"AltGameCancelByHit", "Cast").equalsIgnoreCase("bow")
						|| altSettings
								.getProperty("AltGameCancelByHit", "Cast")
								.equalsIgnoreCase("all");
				ALT_GAME_CANCEL_CAST = altSettings.getProperty(
						"AltGameCancelByHit", "Cast").equalsIgnoreCase("cast")
						|| altSettings
								.getProperty("AltGameCancelByHit", "Cast")
								.equalsIgnoreCase("all");
				ALT_GAME_SHIELD_BLOCKS = Boolean.parseBoolean(altSettings
						.getProperty("AltShieldBlocks", "False"));
				ALT_GAME_DELEVEL = Boolean.parseBoolean(altSettings
						.getProperty("Delevel", "True"));
				ALT_GAME_MAGICFAILURES = Boolean.parseBoolean(altSettings
						.getProperty("MagicFailures", "False"));
				ALT_GAME_MOB_ATTACK_AI = Boolean.parseBoolean(altSettings
						.getProperty("AltGameMobAttackAI", "False"));
				ALT_MOB_AGRO_IN_PEACEZONE = Boolean.parseBoolean(altSettings
						.getProperty("AltMobAgroInPeaceZone", "True"));
				ALT_GAME_EXPONENT_XP = Float.parseFloat(altSettings
						.getProperty("AltGameExponentXp", "0."));
				ALT_GAME_EXPONENT_SP = Float.parseFloat(altSettings
						.getProperty("AltGameExponentSp", "0."));
				ALLOW_CLASS_MASTERS = Boolean.parseBoolean(altSettings
						.getProperty("AllowClassMasters", "False"));
				ALT_GAME_FREIGHTS = Boolean.parseBoolean(altSettings
						.getProperty("AltGameFreights", "False"));
				ALT_GAME_FREIGHT_PRICE = Integer.parseInt(altSettings
						.getProperty("AltGameFreightPrice", "1000"));
				ALT_PARTY_RANGE = Integer.parseInt(altSettings.getProperty(
						"AltPartyRange", "1600"));
				ALT_PARTY_RANGE2 = Integer.parseInt(altSettings.getProperty(
						"AltPartyRange2", "1400"));
				ALT_WEIGHT_LIMIT = Double.parseDouble(altSettings.getProperty(
						"AltWeightLimit", "1"));
				IS_CRAFTING_ENABLED = Boolean.parseBoolean(altSettings
						.getProperty("CraftingEnabled", "True"));
				AUTO_LOOT = Boolean.parseBoolean(altSettings.getProperty(
						"AutoLoot", "True"));
				AUTO_LOOT_RAID = Boolean.valueOf(altSettings.getProperty(
						"AutoLootRaid", "True"));
				AUTO_LOOT_HERBS = Boolean.parseBoolean(altSettings.getProperty(
						"AutoLootHerbs", "True"));
				ALT_GAME_KARMA_PLAYER_CAN_BE_KILLED_IN_PEACEZONE = Boolean
						.parseBoolean(altSettings
								.getProperty(
										"AltKarmaPlayerCanBeKilledInPeaceZone",
										"False"));
				ALT_GAME_KARMA_PLAYER_CAN_SHOP = Boolean
						.parseBoolean(altSettings.getProperty(
								"AltKarmaPlayerCanShop", "True"));
				ALT_GAME_KARMA_PLAYER_CAN_USE_GK = Boolean
						.parseBoolean(altSettings.getProperty(
								"AltKarmaPlayerCanUseGK", "False"));
				ALT_GAME_KARMA_PLAYER_CAN_TELEPORT = Boolean
						.parseBoolean(altSettings.getProperty(
								"AltKarmaPlayerCanTeleport", "True"));
				ALT_GAME_KARMA_PLAYER_CAN_TRADE = Boolean
						.parseBoolean(altSettings.getProperty(
								"AltKarmaPlayerCanTrade", "True"));
				ALT_GAME_KARMA_PLAYER_CAN_USE_WAREHOUSE = Boolean
						.parseBoolean(altSettings.getProperty(
								"AltKarmaPlayerCanUseWareHouse", "True"));
				ALT_GAME_FREE_TELEPORT = Boolean.parseBoolean(altSettings
						.getProperty("AltFreeTeleporting", "False"));
				ALT_RECOMMEND = Boolean.parseBoolean(altSettings.getProperty(
						"AltRecommend", "False"));
				ALT_GAME_SUBCLASS_WITHOUT_QUESTS = Boolean
						.parseBoolean(altSettings.getProperty(
								"AltSubClassWithoutQuests", "False"));
				SUBCLASS_WITH_ITEM_AND_NO_QUEST = Boolean
						.parseBoolean(altSettings.getProperty(
								"SubclassWithItemAndNoQuest", "False"));
				MAX_SUBCLASSES = Integer.parseInt(altSettings.getProperty(
						"MaxSubClasses", "3"));
				KEEP_SUBCLASS_SKILLS = Boolean.parseBoolean(altSettings
						.getProperty("KeepSubClassSkills", "False"));
				RESTORE_EFFECTS_ON_SUBCLASS_CHANGE = Boolean
						.parseBoolean(altSettings.getProperty(
				...
				ALT_MAX_NUM_OF_CLANS_IN_ALLY = Integer.parseInt(altSettings
						.getProperty("AltMaxNumOfClansInAlly", "3"));
				DWARF_RECIPE_LIMIT = Integer.parseInt(altSettings.getProperty(
						"DwarfRecipeLimit", "50"));
				COMMON_RECIPE_LIMIT = Integer.parseInt(altSettings.getProperty(
						"CommonRecipeLimit", "50"));
				ALT_CLAN_MEMBERS_FOR_WAR = Integer.parseInt(altSettings
						.getProperty("AltClanMembersForWar", "15"));
				ALT_CLAN_JOIN_DAYS = Integer.parseInt(altSettings.getProperty(
						"DaysBeforeJoinAClan", "5"));
				ALT_CLAN_CREATE_DAYS = Integer.parseInt(altSettings
						.getProperty("DaysBeforeCreateAClan", "10"));
				...
				ALLOW_MANOR = Boolean.parseBoolean(altSettings.getProperty(
						"AllowManor", "False"));
				ALT_MANOR_REFRESH_TIME = Integer.parseInt(altSettings
						.getProperty("AltManorRefreshTime", "20"));
				ALT_MANOR_REFRESH_MIN = Integer.parseInt(altSettings
						.getProperty("AltManorRefreshMin", "00"));
				ALT_MANOR_APPROVE_TIME = Integer.parseInt(altSettings
						.getProperty("AltManorApproveTime", "6"));
				ALT_MANOR_APPROVE_MIN = Integer.parseInt(altSettings
						.getProperty("AltManorApproveMin", "00"));
				ALT_MANOR_MAINTENANCE_PERIOD = Integer.parseInt(altSettings
						.getProperty("AltManorMaintenancePreiod", "360000"));
				ALT_MANOR_SAVE_ALL_ACTIONS = Boolean.parseBoolean(altSettings
						.getProperty("AltManorSaveAllActions", "False"));
				ALT_MANOR_SAVE_PERIOD_RATE = Integer.parseInt(altSettings
						.getProperty("AltManorSavePeriodRate", "2"));
				RIFT_MIN_PARTY_SIZE = Integer.parseInt(altSettings.getProperty(
						"RiftMinPartySize", "5"));
				RIFT_MAX_JUMPS = Integer.parseInt(altSettings.getProperty(
						"MaxRiftJumps", "4"));
				RIFT_SPAWN_DELAY = Integer.parseInt(altSettings.getProperty(
						"RiftSpawnDelay", "10000"));
				RIFT_AUTO_JUMPS_TIME_MIN = Integer.parseInt(altSettings
						.getProperty("AutoJumpsDelayMin", "480"));
				RIFT_AUTO_JUMPS_TIME_MAX = Integer.parseInt(altSettings
						.getProperty("AutoJumpsDelayMax", "600"));
				RIFT_BOSS_ROOM_TIME_MUTIPLY = Float.parseFloat(altSettings
						.getProperty("BossRoomTimeMultiply", "1.5"));
				RIFT_ENTER_COST_RECRUIT = Integer.parseInt(altSettings
						.getProperty("RecruitCost", "18"));
				RIFT_ENTER_COST_SOLDIER = Integer.parseInt(altSettings
						.getProperty("SoldierCost", "21"));
				RIFT_ENTER_COST_OFFICER = Integer.parseInt(altSettings
						.getProperty("OfficerCost", "24"));
				RIFT_ENTER_COST_CAPTAIN = Integer.parseInt(altSettings
						.getProperty("CaptainCost", "27"));
				RIFT_ENTER_COST_COMMANDER = Integer.parseInt(altSettings
						.getProperty("CommanderCost", "30"));
				RIFT_ENTER_COST_HERO = Integer.parseInt(altSettings
						.getProperty("HeroCost", "33"));
				CASTLE_SHIELD = Boolean.parseBoolean(altSettings.getProperty(
						"CastleShieldRestriction", "True"));
				CLANHALL_SHIELD = Boolean.parseBoolean(altSettings.getProperty(
						"ClanHallShieldRestriction", "True"));
				APELLA_ARMORS = Boolean.parseBoolean(altSettings.getProperty(
						"ApellaArmorsRestriction", "True"));
				OATH_ARMORS = Boolean.parseBoolean(altSettings.getProperty(
						"OathArmorsRestriction", "True"));
				CASTLE_CROWN = Boolean.parseBoolean(altSettings.getProperty(
						"CastleLordsCrownRestriction", "True"));
				CASTLE_CIRCLETS = Boolean.parseBoolean(altSettings.getProperty(
						"CastleCircletsRestriction", "True"));
				ALT_OLY_START_TIME = Integer.parseInt(altSettings.getProperty(
						"AltOlyStartTime", "18"));
				ALT_OLY_MIN = Integer.parseInt(altSettings.getProperty(
						"AltOlyMin", "00"));
				ALT_OLY_CPERIOD = Long.parseLong(altSettings.getProperty(
						"AltOlyCPeriod", "21600")) * 1000;
				ALT_OLY_BATTLE = Long.parseLong(altSettings.getProperty(
						"AltOlyBattle", "360")) * 1000;
				ALT_OLY_BWAIT = Long.parseLong(altSettings.getProperty(
						"AltOlyBWait", "600")) * 1000;
				ALT_OLY_IWAIT = Long.parseLong(altSettings.getProperty(
						"AltOlyIWait", "300")) * 1000;
				ALT_OLY_WPERIOD = Long.parseLong(altSettings.getProperty(
						"AltOlyWPeriod", "604800")) * 1000;
				ALT_OLY_VPERIOD = Long.parseLong(altSettings.getProperty(
						"AltOlyVPeriod", "86400")) * 1000;
				ALT_OLY_CLASSED = Integer.parseInt(altSettings.getProperty(
						"AltOlyClassedParticipants", "5"));
				ALT_OLY_NONCLASSED = Integer.parseInt(altSettings.getProperty(
						"AltOlyNonClassedParticipants", "9"));
				ALT_OLY_BATTLE_REWARD_ITEM = Integer.parseInt(altSettings
						.getProperty("AltOlyBattleRewItem", "6651"));
				ALT_OLY_CLASSED_RITEM_C = Integer.parseInt(altSettings
						.getProperty("AltOlyClassedRewItemCount", "50"));
				ALT_OLY_NONCLASSED_RITEM_C = Integer.parseInt(altSettings
						.getProperty("AltOlyNonClassedRewItemCount", "30"));
				ALT_OLY_COMP_RITEM = Integer.parseInt(altSettings.getProperty(
						"AltOlyCompRewItem", "6651"));
				ALT_OLY_GP_PER_POINT = Integer.parseInt(altSettings
						.getProperty("AltOlyGPPerPoint", "1000"));
				ALT_OLY_MIN_POINT_FOR_EXCH = Integer.parseInt(altSettings
						.getProperty("AltOlyMinPointForExchange", "50"));
				ALT_OLY_HERO_POINTS = Integer.parseInt(altSettings.getProperty(
						"AltOlyHeroPoints", "300"));
				ALT_OLY_RESTRICTED_ITEMS = altSettings.getProperty(
				...
				ALT_LOTTERY_PRIZE = Integer.parseInt(altSettings.getProperty(
				...
				BUFFS_MAX_AMOUNT = Byte.parseByte(altSettings.getProperty(
						"MaxBuffAmount", "24"));
				ALT_DEV_NO_QUESTS = Boolean.parseBoolean(altSettings
						.getProperty("AltDevNoQuests", "False"));
				ALT_DEV_NO_SPAWNS = Boolean.parseBoolean(altSettings
						.getProperty("AltDevNoSpawns", "False"));
			} catch (Exception e) {
				e.printStackTrace();
				throw new Error("Failed to Load " + ALT_SETTINGS_FILE
						+ " File.");
			}
			// clanhall settings
			try {
				...
				is.close();
				CH_TELE_FEE_RATIO = Long.parseLong(clanhallSettings
						.getProperty("ClanHallTeleportFunctionFeeRation",
								"86400000"));
				CH_TELE1_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallTeleportFunctionFeeLvl1", "86400000"));
				CH_TELE2_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallTeleportFunctionFeeLvl2", "86400000"));
				CH_SUPPORT_FEE_RATIO = Long.parseLong(clanhallSettings
						.getProperty("ClanHallSupportFunctionFeeRation",
								"86400000"));
				CH_SUPPORT1_FEE = Integer.parseInt(clanhallSettings
						.getProperty("ClanHallSupportFeeLvl1", "86400000"));
				CH_SUPPORT2_FEE = Integer.parseInt(clanhallSettings
						.getProperty("ClanHallSupportFeeLvl2", "86400000"));
				CH_SUPPORT3_FEE = Integer.parseInt(clanhallSettings
						.getProperty("ClanHallSupportFeeLvl3", "86400000"));
				CH_SUPPORT4_FEE = Integer.parseInt(clanhallSettings
						.getProperty("ClanHallSupportFeeLvl4", "86400000"));
				CH_SUPPORT5_FEE = Integer.parseInt(clanhallSettings
						.getProperty("ClanHallSupportFeeLvl5", "86400000"));
				CH_SUPPORT6_FEE = Integer.parseInt(clanhallSettings
						.getProperty("ClanHallSupportFeeLvl6", "86400000"));
				CH_SUPPORT7_FEE = Integer.parseInt(clanhallSettings
						.getProperty("ClanHallSupportFeeLvl7", "86400000"));
				CH_SUPPORT8_FEE = Integer.parseInt(clanhallSettings
						.getProperty("ClanHallSupportFeeLvl8", "86400000"));
				CH_MPREG_FEE_RATIO = Long.parseLong(clanhallSettings
						.getProperty("ClanHallMpRegenerationFunctionFeeRation",
								"86400000"));
				CH_MPREG1_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallMpRegenerationFeeLvl1", "86400000"));
				CH_MPREG2_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallMpRegenerationFeeLvl2", "86400000"));
				CH_MPREG3_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallMpRegenerationFeeLvl3", "86400000"));
				CH_MPREG4_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallMpRegenerationFeeLvl4", "86400000"));
				CH_MPREG5_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallMpRegenerationFeeLvl5", "86400000"));
				CH_HPREG_FEE_RATIO = Long.parseLong(clanhallSettings
						.getProperty("ClanHallHpRegenerationFunctionFeeRation",
								"86400000"));
				CH_HPREG1_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallHpRegenerationFeeLvl1", "86400000"));
				CH_HPREG2_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallHpRegenerationFeeLvl2", "86400000"));
				CH_HPREG3_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallHpRegenerationFeeLvl3", "86400000"));
				CH_HPREG4_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallHpRegenerationFeeLvl4", "86400000"));
				CH_HPREG5_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallHpRegenerationFeeLvl5", "86400000"));
				CH_HPREG6_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallHpRegenerationFeeLvl6", "86400000"));
				CH_HPREG7_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallHpRegenerationFeeLvl7", "86400000"));
				CH_HPREG8_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallHpRegenerationFeeLvl8", "86400000"));
				CH_HPREG9_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallHpRegenerationFeeLvl9", "86400000"));
				CH_HPREG10_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallHpRegenerationFeeLvl10", "86400000"));
				CH_HPREG11_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallHpRegenerationFeeLvl11", "86400000"));
				CH_HPREG12_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallHpRegenerationFeeLvl12", "86400000"));
				CH_HPREG13_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallHpRegenerationFeeLvl13", "86400000"));
				CH_EXPREG_FEE_RATIO = Long.parseLong(clanhallSettings
						.getProperty(
								"ClanHallExpRegenerationFunctionFeeRation",
								"86400000"));
				CH_EXPREG1_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallExpRegenerationFeeLvl1", "86400000"));
				CH_EXPREG2_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallExpRegenerationFeeLvl2", "86400000"));
				CH_EXPREG3_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallExpRegenerationFeeLvl3", "86400000"));
				CH_EXPREG4_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallExpRegenerationFeeLvl4", "86400000"));
				CH_EXPREG5_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallExpRegenerationFeeLvl5", "86400000"));
				CH_EXPREG6_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallExpRegenerationFeeLvl6", "86400000"));
				CH_EXPREG7_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallExpRegenerationFeeLvl7", "86400000"));
				CH_ITEM_FEE_RATIO = Long.parseLong(clanhallSettings
						.getProperty("ClanHallItemCreationFunctionFeeRation",
								"86400000"));
				CH_ITEM1_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallItemCreationFunctionFeeLvl1", "86400000"));
				CH_ITEM2_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallItemCreationFunctionFeeLvl2", "86400000"));
				CH_ITEM3_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallItemCreationFunctionFeeLvl3", "86400000"));
				CH_CURTAIN_FEE_RATIO = Long.parseLong(clanhallSettings
						.getProperty("ClanHallCurtainFunctionFeeRation",
								"86400000"));
				CH_CURTAIN1_FEE = Integer.parseInt(clanhallSettings
						.getProperty("ClanHallCurtainFunctionFeeLvl1",
								"86400000"));
				CH_CURTAIN2_FEE = Integer.parseInt(clanhallSettings
						.getProperty("ClanHallCurtainFunctionFeeLvl2",
								"86400000"));
				CH_FRONT_FEE_RATIO = Long.parseLong(clanhallSettings
						.getProperty("ClanHallFrontPlatformFunctionFeeRation",
								"86400000"));
				CH_FRONT1_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallFrontPlatformFunctionFeeLvl1", "86400000"));
				CH_FRONT2_FEE = Integer.parseInt(clanhallSettings.getProperty(
						"ClanHallFrontPlatformFunctionFeeLvl2", "86400000"));
			} catch (Exception e) {
				e.printStackTrace();
				throw new Error("Failed to Load " + CLANHALL_CONFIG_FILE
						+ " File.");
			}
			// FloodProtector
			try {
				...
				InputStream is = new FileInputStream(new File(
						FLOODPROTECTOR_CONFIG_FILE));
				FloodProtector.load(is);
				is.close();
				loadFloodProtectorConfigs(FloodProtector);
			} catch (Exception e) {
				e.printStackTrace();
				throw new Error("Failed to Load " + FLOODPROTECTOR_CONFIG_FILE
						+ " File.");
			}
			try {
				...
				GM_ACCESSLEVEL = Integer.parseInt(gmSettings.getProperty(
						"GMAccessLevel", "100"));
				GM_MIN = Integer.parseInt(gmSettings.getProperty("GMMinLevel",
						"100"));
				GM_ALTG_MIN_LEVEL = Integer.parseInt(gmSettings.getProperty(
						"GMCanAltG", "100"));
				GM_ANNOUNCE = Integer.parseInt(gmSettings.getProperty(
						"GMCanAnnounce", "100"));
				GM_BAN = Integer.parseInt(gmSettings.getProperty("GMCanBan",
						"100"));
				...
				GM_DELETE = Integer.parseInt(gmSettings.getProperty(
						"GMCanDelete", "100"));
				GM_KICK = Integer.parseInt(gmSettings.getProperty("GMCanKick",
						"100"));
				...
				GM_CHAR_EDIT = Integer.parseInt(gmSettings.getProperty(
						"GMCanEditChar", "100"));
				GM_CHAR_EDIT_OTHER = Integer.parseInt(gmSettings.getProperty(
				...
				GM_TELEPORT = Integer.parseInt(gmSettings.getProperty(
						"GMCanTeleport", "100"));
				GM_TELEPORT_OTHER = Integer.parseInt(gmSettings.getProperty(
				...
				GM_MONSTERRACE = Integer.parseInt(gmSettings.getProperty(
						"GMMonsterRace", "100"));
				GM_RIDER = Integer.parseInt(gmSettings.getProperty("GMRider",
						"100"));
				...
				GM_DOOR = Integer.parseInt(gmSettings.getProperty("GMDoor",
						"100"));
				GM_RES = Integer.parseInt(gmSettings
						.getProperty("GMRes", "100"));
				...
				GM_UNBLOCK = Integer.parseInt(gmSettings.getProperty(
						"GMUnblock", "100"));
				GM_CACHE = Integer.parseInt(gmSettings.getProperty("GMCache",
						"100"));
				...
				GM_CAN_GIVE_DAMAGE = Integer.parseInt(gmSettings.getProperty(
						"GMCanGiveDamage", "90"));
				GM_DONT_TAKE_AGGRO = Integer.parseInt(gmSettings.getProperty(
						"GMDontTakeAggro", "90"));
				GM_DONT_TAKE_EXPSP = Integer.parseInt(gmSettings.getProperty(
						"GMDontGiveExpSp", "90"));
			} catch (Exception e) {
				e.printStackTrace();
			...
			try {
				...
				IDFACTORY_TYPE = IdFactoryType.valueOf(idSettings.getProperty(
						"IDFactory", "Compaction"));
				BAD_ID_CHECKING = Boolean.parseBoolean(idSettings.getProperty(
						"BadIdChecking", "True"));
			} catch (Exception e) {
				e.printStackTrace();
			...
			try {
				...
				ircSettings.load(is);
				is.close();
				IRC_HOSTNAME = ircSettings.getProperty("IrcHostname",
						"localhost");
				IRC_PORT = Integer.parseInt(ircSettings.getProperty("IrcPort",
						"6667"));
				IRC_USERNAME = ircSettings.getProperty("IrcUserNick", "L2JBot");
				IRC_USERREALNAME = ircSettings.getProperty("IrcUserRealName",
						"L2JBot");
				IRC_USERMAIL = ircSettings.getProperty("IrcUserMail");
				IRC_CHANNEL = ircSettings.getProperty("IrcChannel");
				IRC_IGTOIRC_FILE = ircSettings.getProperty("IrcIgToIrcFile",
						"./log/igtoirc.log");
				IRC_KEYWORDTOIG = ircSettings.getProperty("IrcKeywordToIg");
				IRC_KEYWORDTOIRC = ircSettings.getProperty("IrcKeywordToIrc");
				IRC_LOAD = Boolean.parseBoolean(ircSettings.getProperty(
						"StartIrcBot", "False"));
			} catch (Exception e) {
				e.printStackTrace();
			...
			try {
				...
				DEBUG = Boolean.parseBoolean(optionsSettings.getProperty(
						"Debug", "False"));
				ASSERT = Boolean.parseBoolean(optionsSettings.getProperty(
						"Assert", "False"));
				DEVELOPER = Boolean.parseBoolean(optionsSettings.getProperty(
						"Developer", "False"));
				TEST_SERVER = Boolean.parseBoolean(optionsSettings.getProperty(
						"TestServer", "False"));
				SERVER_LIST_TESTSERVER = Boolean.parseBoolean(optionsSettings
						.getProperty("TestServer", "False"));
				SERVER_LIST_BRACKET = Boolean.parseBoolean(optionsSettings
						.getProperty("ServerListBrackets", "False"));
				SERVER_LIST_CLOCK = Boolean.parseBoolean(optionsSettings
						.getProperty("ServerListClock", "False"));
				SERVER_GMONLY = Boolean.parseBoolean(optionsSettings
						.getProperty("ServerGMOnly", "False"));
				...
				SAVE_DROPPED_ITEM_INTERVAL = Integer.parseInt(optionsSettings
						.getProperty("SaveDroppedItemInterval", "0")) * 60000;
				CLEAR_DROPPED_ITEM_TABLE = Boolean.parseBoolean(optionsSettings
						.getProperty("ClearDroppedItemTable", "False"));
				PRECISE_DROP_CALCULATION = Boolean.parseBoolean(optionsSettings
				...
				ALLOW_WEAR = Boolean.parseBoolean(optionsSettings.getProperty(
						"AllowWear", "False"));
				...
				ALLOW_RACE = Boolean.parseBoolean(optionsSettings.getProperty(
						"AllowRace", "False"));
				ALLOW_WATER = Boolean.parseBoolean(optionsSettings.getProperty(
						"AllowWater", "False"));
				...
				FLOODPROTECTOR_INITIALSIZE = Integer.parseInt(optionsSettings
						.getProperty("FloodProtectorInitialSize", "50"));
				...
				ALLOW_BOAT = Boolean.parseBoolean(optionsSettings.getProperty(
						"AllowBoat", "False"));
				...
				ACTIVATE_POSITION_RECORDER = Boolean
						.parseBoolean(optionsSettings.getProperty(
				...
				DEFAULT_TRADE_CHAT = optionsSettings.getProperty("TradeChat",
						"ON");
				LOG_CHAT = Boolean.parseBoolean(optionsSettings.getProperty(
						"LogChat", "False"));
				LOG_ITEMS = Boolean.parseBoolean(optionsSettings.getProperty(
						"LogItems", "False"));
				LOG_TRADES = Boolean.parseBoolean(optionsSettings.getProperty(
						"LogTrades", "False"));
				LOG_PDAM = Boolean.parseBoolean(optionsSettings.getProperty(
						"LogPdam", "False"));
				LOG_MDAM = Boolean.parseBoolean(optionsSettings.getProperty(
						"LogMdam", "False"));
				GMAUDIT = Boolean.parseBoolean(optionsSettings.getProperty(
						"GMAudit", "True"));
				COMMUNITY_TYPE = optionsSettings.getProperty("CommunityType",
						"old").toLowerCase();
				...
				ZONE_TOWN = Integer.parseInt(optionsSettings.getProperty(
						"ZoneTown", "0"));
				MAX_DRIFT_RANGE = Integer.parseInt(optionsSettings.getProperty(
						"MaxDriftRange", "300"));
				MIN_NPC_ANIMATION = Integer.parseInt(optionsSettings
						.getProperty("MinNPCAnimation", "10"));
				MAX_NPC_ANIMATION = Integer.parseInt(optionsSettings
						.getProperty("MaxNPCAnimation", "20"));
				SHOW_NPC_LVL = Boolean.parseBoolean(optionsSettings
						.getProperty("ShowNpcLevel", "False"));
				FORCE_INVENTORY_UPDATE = Boolean.parseBoolean(optionsSettings
				...
				IO_PACKET_THREAD_CORE_SIZE = Integer.parseInt(optionsSettings
						.getProperty("UrgentPacketThreadCoreSize", "2"));
				AI_MAX_THREAD = Integer.parseInt(optionsSettings.getProperty(
						"AiMaxThread", "10"));
				GENERAL_THREAD_CORE_SIZE = Integer.parseInt(optionsSettings
						.getProperty("GeneralThreadCoreSize", "4"));
				DELETE_DAYS = Integer.parseInt(optionsSettings.getProperty(
						"DeleteCharAfterDays", "7"));
				DEFAULT_PUNISH = Integer.parseInt(optionsSettings.getProperty(
						"DefaultPunish", "2"));
				DEFAULT_PUNISH_PARAM = Integer.parseInt(optionsSettings
						.getProperty("DefaultPunishParam", "0"));
				LAZY_CACHE = Boolean.parseBoolean(optionsSettings.getProperty(
						"LazyCache", "False"));
				PACKET_LIFETIME = Integer.parseInt(optionsSettings.getProperty(
						"PacketLifeTime", "0"));
				...
				GAMEGUARD_PROHIBITACTION = Boolean.parseBoolean(optionsSettings
				...
				ACCEPT_GEOEDITOR_CONN = Boolean.parseBoolean(optionsSettings
						.getProperty("AcceptGeoeditorConn", "False"));
				// ---------------------------------------------------
				// Configuration values not found in config files
				// ---------------------------------------------------
				USE_3D_MAP = Boolean.parseBoolean(optionsSettings.getProperty(
						"Use3DMap", "False"));
				...
				LINKED_NODE_ID = Integer.parseInt(optionsSettings.getProperty(
						"NewNodeId", "7952"));
				...
				CHECK_KNOWN = Boolean.parseBoolean(optionsSettings.getProperty(
			...
			try {
				...
				ALLOW_GUARDS = Boolean.parseBoolean(otherSettings.getProperty(
						"AllowGuards", "False"));
				EFFECT_CANCELING = Boolean.parseBoolean(otherSettings
						.getProperty("CancelLesserEffect", "True"));
				WYVERN_SPEED = Integer.parseInt(otherSettings.getProperty(
						"WyvernSpeed", "100"));
				STRIDER_SPEED = Integer.parseInt(otherSettings.getProperty(
						"StriderSpeed", "80"));
				ALLOW_WYVERN_UPGRADER = Boolean.parseBoolean(otherSettings
				...
				MAX_ITEM_IN_PACKET = Math.max(INVENTORY_MAXIMUM_NO_DWARF, Math
						.max(INVENTORY_MAXIMUM_DWARF, INVENTORY_MAXIMUM_GM));
				/* Inventory slots limits */
				...
				FREIGHT_SLOTS = Integer.parseInt(otherSettings.getProperty(
						"MaximumFreightSlots", "20"));
				/* chance to enchant an item over +3 */
				ENCHANT_CHANCE_WEAPON = Integer.parseInt(otherSettings
						.getProperty("EnchantChanceWeapon", "68"));
				ENCHANT_CHANCE_ARMOR = Integer.parseInt(otherSettings
						.getProperty("EnchantChanceArmor", "52"));
				ENCHANT_CHANCE_JEWELRY = Integer.parseInt(otherSettings
						.getProperty("EnchantChanceJewelry", "54"));
				ENCHANT_CHANCE_WEAPON_CRYSTAL = Integer.parseInt(otherSettings
						.getProperty("EnchantChanceWeaponCrystal", "85"));
				ENCHANT_CHANCE_ARMOR_CRYSTAL = Integer.parseInt(otherSettings
						.getProperty("EnchantChanceArmorCrystal", "85"));
				ENCHANT_CHANCE_JEWELRY_CRYSTAL = Integer.parseInt(otherSettings
						.getProperty("EnchantChanceJewelryCrystal", "85"));
				ENCHANT_CHANCE_WEAPON_BLESSED = Integer.parseInt(otherSettings
						.getProperty("EnchantChanceWeaponBlessed", "55"));
				ENCHANT_CHANCE_ARMOR_BLESSED = Integer.parseInt(otherSettings
						.getProperty("EnchantChanceArmorBlessed", "55"));
				ENCHANT_CHANCE_JEWELRY_BLESSED = Integer.parseInt(otherSettings
						.getProperty("EnchantChanceJewelryBlessed", "55"));
				ENABLE_DWARF_ENCHANT_BONUS = Boolean.parseBoolean(otherSettings
						.getProperty("EnableDwarfEnchantBonus", "False"));
				DWARF_ENCHANT_MIN_LEVEL = Integer.parseInt(otherSettings
						.getProperty("DwarfEnchantMinLevel", "80"));
				DWARF_ENCHANT_BONUS = Integer.parseInt(otherSettings
						.getProperty("DwarfEnchantBonus", "15"));
				ENCHANT_HERO_WEAPONS = Boolean.parseBoolean(otherSettings
						.getProperty("EnchantHeroWeapons", "False"));
				/* limit on enchant */
				ENCHANT_MAX_WEAPON = Integer.parseInt(otherSettings
						.getProperty("EnchantMaxWeapon", "255"));
				ENCHANT_MAX_ARMOR = Integer.parseInt(otherSettings.getProperty(
						"EnchantMaxArmor", "255"));
				ENCHANT_MAX_JEWELRY = Integer.parseInt(otherSettings
						.getProperty("EnchantMaxJewelry", "255"));
				/* limit of safe enchant normal */
				ENCHANT_SAFE_MAX = Integer.parseInt(otherSettings.getProperty(
						"EnchantSafeMax", "3"));
				/* limit of safe enchant full */
				ENCHANT_SAFE_MAX_FULL = Integer.parseInt(otherSettings
						.getProperty("EnchantSafeMaxFull", "4"));
				/*
				 * if different from 100 (ie 100%) heal rate is modified
				 * acordingly
				 */
				HP_REGEN_MULTIPLIER = Double.parseDouble(otherSettings
						.getProperty("HpRegenMultiplier", "100")) / 100;
				MP_REGEN_MULTIPLIER = Double.parseDouble(otherSettings
						.getProperty("MpRegenMultiplier", "100")) / 100;
				CP_REGEN_MULTIPLIER = Double.parseDouble(otherSettings
						.getProperty("CpRegenMultiplier", "100")) / 100;
				RAID_HP_REGEN_MULTIPLIER = Double.parseDouble(otherSettings
						.getProperty("RaidHpRegenMultiplier", "100")) / 100;
				RAID_MP_REGEN_MULTIPLIER = Double.parseDouble(otherSettings
						.getProperty("RaidMpRegenMultiplier", "100")) / 100;
				RAID_DEFENCE_MULTIPLIER = Double.parseDouble(otherSettings
				...
				STARTING_ADENA = Integer.parseInt(otherSettings.getProperty(
						"StartingAdena", "100"));
				UNSTUCK_INTERVAL = Integer.parseInt(otherSettings.getProperty(
						"UnstuckInterval", "300"));
				...
				PARTY_XP_CUTOFF_METHOD = otherSettings.getProperty(
						"PartyXpCutoffMethod", "percentage");
				PARTY_XP_CUTOFF_PERCENT = Double.parseDouble(otherSettings
						.getProperty("PartyXpCutoffPercent", "3."));
				PARTY_XP_CUTOFF_LEVEL = Integer.parseInt(otherSettings
						.getProperty("PartyXpCutoffLevel", "30"));
				/* Amount of HP, MP, and CP is restored */
				RESPAWN_RESTORE_CP = Double.parseDouble(otherSettings
						.getProperty("RespawnRestoreCP", "0")) / 100;
				RESPAWN_RESTORE_HP = Double.parseDouble(otherSettings
						.getProperty("RespawnRestoreHP", "70")) / 100;
				RESPAWN_RESTORE_MP = Double.parseDouble(otherSettings
						.getProperty("RespawnRestoreMP", "70")) / 100;
				...
				ALT_PRIVILEGES_SECURE_CHECK = Boolean
						.parseBoolean(otherSettings.getProperty(
				...
				ADMIN_NAME_COLOR = Integer
						.decode("0x"
								+ otherSettings.getProperty("AdminNameColor",
										"00FF00"));
				GM_HERO_AURA = Boolean.parseBoolean(otherSettings.getProperty(
						"GMHeroAura", "True"));
				...
				MASTERACCESS_LEVEL = Integer.parseInt(otherSettings
						.getProperty("MasterAccessLevel", "1"));
				MASTERACCESS_NAME_COLOR = Integer.decode("0x"
						+ otherSettings
								.getProperty("MasterNameColor", "00FF00"));
				MASTERACCESS_TITLE_COLOR = Integer.decode("0x"
						+ otherSettings.getProperty("MasterTitleColor",
								"00FF00"));
				GM_STARTUP_SILENCE = Boolean.parseBoolean(otherSettings
						.getProperty("GMStartupSilence", "True"));
				GM_STARTUP_AUTO_LIST = Boolean.parseBoolean(otherSettings
				...
				MAX_PETITIONS_PENDING = Integer.parseInt(otherSettings
						.getProperty("MaxPetitionsPending", "25"));
				JAIL_IS_PVP = Boolean.parseBoolean(otherSettings.getProperty(
						"JailIsPvp", "True"));
				JAIL_DISABLE_CHAT = Boolean.parseBoolean(otherSettings
						.getProperty("JailDisableChat", "True"));
			} catch (Exception e) {
				e.printStackTrace();
				throw new Error("Failed to Load " + OTHER_CONFIG_FILE
						+ " File.");
			}
			// General Config File
			try {
				...
				is.close();
				/** Devastated Castle */
				DEVASTATED_CASTLE_ENABLED = Boolean.parseBoolean(General
						.getProperty("DevastatedCastleEnabled", "False"));
				/** Fortress of The Dead */
				FORTRESS_OF_THE_DEAD_ENABLED = Boolean.parseBoolean(General
						.getProperty("FortressofTheDeadEnabled", "False"));
				FAILD_FAKEDEATH = Boolean.parseBoolean(General.getProperty(
						"FaildFakeDeath", "True"));
				/** L2J NPC Buffer by House */
				NPCBUFFER_FEATURE_ENABLED = Boolean.parseBoolean(General
						.getProperty("NPCBufferEnabled", "False"));
				NPCBUFFER_MAX_SCHEMES = Integer.parseInt(General.getProperty(
						"NPCBufferMaxSchemesPerChar", "4"));
				NPCBUFFER_MAX_SKILLS = Integer.parseInt(General.getProperty(
						"NPCBufferMaxSkllsperScheme", "24"));
				NPCBUFFER_STORE_SCHEMES = Boolean.parseBoolean(General
						.getProperty("NPCBufferStoreSchemes", "True"));
				NPCBUFFER_STATIC_BUFF_COST = Integer.parseInt(General
						.getProperty("NPCBufferStaticCostPerBuff", "-1"));
			} catch (Exception e) {
				e.printStackTrace();
			...
			try {
				...
				is.close();
				OLYMPIAD_ALLOW_AUTO_SS = Boolean.parseBoolean(OlympiadSettings
						.getProperty("OlympiadAllowAutoSS", "True"));
				OLYMPIAD_GIVE_ACUMEN_MAGES = Boolean
						.parseBoolean(OlympiadSettings.getProperty(
								"OlympiadGiveAcumenMages", "False"));
				OLYMPIAD_GIVE_HASTE_FIGHTERS = Boolean
						.parseBoolean(OlympiadSettings.getProperty(
								"OlympiadGiveHasteFighters", "True"));
				OLYMPIAD_ACUMEN_LVL = Integer.parseInt(OlympiadSettings
						.getProperty("OlympiadAcumenLvl", "1"));
				OLYMPIAD_HASTE_LVL = Integer.parseInt(OlympiadSettings
						.getProperty("OlympiadHasteLvl", "2"));
				OLY_ENCHANT_LIMIT = Integer.parseInt(OlympiadSettings
						.getProperty("OlyMaxEnchant", "-1"));
			} catch (Exception e) {
				e.printStackTrace();
			...
			try {
				...
				for (int j = 0; j < k; j++) {
					...
					if (t2.contains("-")) {
						...
						INVUL_NPC_LIST.add(Integer
								.valueOf(Integer.parseInt(t2)));
					}
				}
				DISABLE_ATTACK_NPC_TYPE = Boolean.parseBoolean(Feature
				...
				FS_TELE_FEE_RATIO = Long.parseLong(Feature.getProperty(
						"FortressTeleportFunctionFeeRatio", "604800000"));
				FS_TELE1_FEE = Integer.parseInt(Feature.getProperty(
						"FortressTeleportFunctionFeeLvl1", "1000"));
				FS_TELE2_FEE = Integer.parseInt(Feature.getProperty(
						"FortressTeleportFunctionFeeLvl2", "10000"));
				FS_SUPPORT_FEE_RATIO = Long.parseLong(Feature.getProperty(
						"FortressSupportFunctionFeeRatio", "86400000"));
				FS_SUPPORT1_FEE = Integer.parseInt(Feature.getProperty(
						"FortressSupportFeeLvl1", "7000"));
				FS_SUPPORT2_FEE = Integer.parseInt(Feature.getProperty(
						"FortressSupportFeeLvl2", "17000"));
				FS_MPREG_FEE_RATIO = Long.parseLong(Feature.getProperty(
						"FortressMpRegenerationFunctionFeeRatio", "86400000"));
				FS_MPREG1_FEE = Integer.parseInt(Feature.getProperty(
						"FortressMpRegenerationFeeLvl1", "6500"));
				FS_MPREG2_FEE = Integer.parseInt(Feature.getProperty(
						"FortressMpRegenerationFeeLvl2", "9300"));
				FS_HPREG_FEE_RATIO = Long.parseLong(Feature.getProperty(
						"FortressHpRegenerationFunctionFeeRatio", "86400000"));
				FS_HPREG1_FEE = Integer.parseInt(Feature.getProperty(
						"FortressHpRegenerationFeeLvl1", "2000"));
				FS_HPREG2_FEE = Integer.parseInt(Feature.getProperty(
						"FortressHpRegenerationFeeLvl2", "3500"));
				FS_EXPREG_FEE_RATIO = Long.parseLong(Feature.getProperty(
						"FortressExpRegenerationFunctionFeeRatio", "86400000"));
				FS_EXPREG1_FEE = Integer.parseInt(Feature.getProperty(
						"FortressExpRegenerationFeeLvl1", "9000"));
				FS_EXPREG2_FEE = Integer.parseInt(Feature.getProperty(
						"FortressExpRegenerationFeeLvl2", "10000"));
				NPC_ATTACKABLE = Boolean.parseBoolean(Feature.getProperty(
						"NpcAttackable", "False"));
			} catch (Exception e) {
				e.printStackTrace();
			...
			try {
				...
				AUGMENTATION_BASESTAT_CHANCE = Integer.parseInt(Augment
						.getProperty("AugmentationBaseStatChance", "1"));
				AUGMENTATION_NG_SKILL_CHANCE = Integer.parseInt(Augment
						.getProperty("AugmentationNGSkillChance", "15"));
				AUGMENTATION_NG_GLOW_CHANCE = Integer.parseInt(Augment
						.getProperty("AugmentationNGGlowChance", "0"));
				AUGMENTATION_MID_SKILL_CHANCE = Integer.parseInt(Augment
						.getProperty("AugmentationMidSkillChance", "30"));
				AUGMENTATION_MID_GLOW_CHANCE = Integer.parseInt(Augment
						.getProperty("AugmentationMidGlowChance", "40"));
				AUGMENTATION_HIGH_SKILL_CHANCE = Integer.parseInt(Augment
						.getProperty("AugmentationHighSkillChance", "45"));
				AUGMENTATION_HIGH_GLOW_CHANCE = Integer.parseInt(Augment
						.getProperty("AugmentationHighGlowChance", "70"));
				AUGMENTATION_TOP_SKILL_CHANCE = Integer.parseInt(Augment
						.getProperty("AugmentationTopSkillChance", "60"));
				AUGMENTATION_TOP_GLOW_CHANCE = Integer.parseInt(Augment
						.getProperty("AugmentationTopGlowChance", "100"));
			} catch (Exception e) {
				e.printStackTrace();
				throw new Error("Failed to Load " + AUGMENT_CONFIG_FILE
						+ " File.");
			}
			try {
			...
			try {
				...
				is.close();
				RATE_XP = Float.parseFloat(ratesSettings.getProperty("RateXp",
						"1."));
				RATE_SP = Float.parseFloat(ratesSettings.getProperty("RateSp",
						"1."));
				...
				RATE_DROP_ADENA = Float.parseFloat(ratesSettings.getProperty(
						"RateDropAdena", "1."));
				RATE_CONSUMABLE_COST = Float.parseFloat(ratesSettings
						.getProperty("RateConsumableCost", "1."));
				RATE_DROP_ITEMS = Float.parseFloat(ratesSettings.getProperty(
						"RateDropItems", "1."));
				RATE_DROP_SPOIL = Float.parseFloat(ratesSettings.getProperty(
						"RateDropSpoil", "1."));
				RATE_DROP_MANOR = Integer.parseInt(ratesSettings.getProperty(
						"RateDropManor", "1"));
				// ADENA BOSS
				ADENA_BOSS = Float.parseFloat(ratesSettings.getProperty(
						"AdenaBoss", "1."));
				ADENA_RAID = Float.parseFloat(ratesSettings.getProperty(
						"AdenaRaid", "1."));
				ADENA_MINON = Float.parseFloat(ratesSettings.getProperty(
						"AdenaMinon", "1."));
				// ITEMS BOSS
				ITEMS_BOSS = Float.parseFloat(ratesSettings.getProperty(
						"ItemsBoss", "1."));
				ITEMS_RAID = Float.parseFloat(ratesSettings.getProperty(
						"ItemsRaid", "1."));
				ITEMS_MINON = Float.parseFloat(ratesSettings.getProperty(
						"ItemsMinon", "1."));
				// SPOIL BOSS
				SPOIL_BOSS = Float.parseFloat(ratesSettings.getProperty(
						"SpoilBoss", "1."));
				SPOIL_RAID = Float.parseFloat(ratesSettings.getProperty(
						"SpoilRaid", "1."));
				SPOIL_MINON = Float.parseFloat(ratesSettings.getProperty(
						"SpoilMinon", "1."));
				RATE_DROP_QUEST = Float.parseFloat(ratesSettings.getProperty(
						"RateDropQuest", "1."));
				...
				PLAYER_DROP_LIMIT = Integer.parseInt(ratesSettings.getProperty(
						"PlayerDropLimit", "3"));
				PLAYER_RATE_DROP = Integer.parseInt(ratesSettings.getProperty(
						"PlayerRateDrop", "5"));
				...
				PET_FOOD_RATE = Integer.parseInt(ratesSettings.getProperty(
						"PetFoodRate", "1"));
				SINEATER_XP_RATE = Float.parseFloat(ratesSettings.getProperty(
						"SinEaterXpRate", "1."));
				KARMA_DROP_LIMIT = Integer.parseInt(ratesSettings.getProperty(
						"KarmaDropLimit", "10"));
				KARMA_RATE_DROP = Integer.parseInt(ratesSettings.getProperty(
						"KarmaRateDrop", "70"));
			...
			try {
				...
				// TVT Event Engine //
				// -------------------- //
				TVT_EVEN_TEAMS = L2JTeonEventMods.getProperty("TvTEvenTeams",
						"BALANCE");
				TVT_ALLOW_INTERFERENCE = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("TvTAllowInterference", "False"));
				TVT_ALLOW_POTIONS = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("TvTAllowPotions", "False"));
				TVT_ALLOW_SUMMON = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("TvTAllowSummon", "False"));
				TVT_ON_START_REMOVE_ALL_EFFECTS = Boolean
						.parseBoolean(L2JTeonEventMods.getProperty(
								"TvTOnStartRemoveAllEffects", "True"));
				TVT_ON_START_UNSUMMON_PET = Boolean
						.parseBoolean(L2JTeonEventMods.getProperty(
								"TvTOnStartUnsummonPet", "True"));
				TVT_REVIVE_RECOVERY = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("TvTReviveRecovery", "False"));
				TVT_ANNOUNCE_TEAM_STATS = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("TvtAnnounceTeamStats", "False"));
				TVT_PRICE_NO_KILLS = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("TvtPriceNoKills", "False"));
				TVT_JOIN_CURSED = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("TvtJoinWithCursedWeapon", "True"));
				// -------------------- //
				// CTF Event Engine //
				// -------------------- //
				CTF_EVEN_TEAMS = L2JTeonEventMods.getProperty("CTFEvenTeams",
						"BALANCE");
				CTF_ALLOW_INTERFERENCE = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("CTFAllowInterference", "False"));
				CTF_ALLOW_POTIONS = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("CTFAllowPotions", "False"));
				CTF_ALLOW_SUMMON = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("CTFAllowSummon", "False"));
				CTF_ON_START_REMOVE_ALL_EFFECTS = Boolean
						.parseBoolean(L2JTeonEventMods.getProperty(
								"CTFOnStartRemoveAllEffects", "True"));
				CTF_ON_START_UNSUMMON_PET = Boolean
						.parseBoolean(L2JTeonEventMods.getProperty(
								"CTFOnStartUnsummonPet", "True"));
				CTF_ANNOUNCE_TEAM_STATS = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("CTFAnnounceTeamStats", "False"));
				CTF_JOIN_CURSED = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("CTFJoinWithCursedWeapon", "True"));
				CTF_REVIVE_RECOVERY = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("CTFReviveRecovery", "False"));
				// -------------------- //
				// DM Event Engine //
				// -------------------- //
				DM_ALLOW_INTERFERENCE = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("DMAllowInterference", "False"));
				DM_ALLOW_POTIONS = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("DMAllowPotions", "False"));
				DM_ALLOW_SUMMON = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("DMAllowSummon", "False"));
				DM_ON_START_REMOVE_ALL_EFFECTS = Boolean
						.parseBoolean(L2JTeonEventMods.getProperty(
								"DMOnStartRemoveAllEffects", "True"));
				DM_ON_START_UNSUMMON_PET = Boolean
						.parseBoolean(L2JTeonEventMods.getProperty(
								"DMOnStartUnsummonPet", "True"));
				// -------------------- //
				// KvN Engine //
				// -------------------- //
				ENABLE_FACTION_KOOFS_NOOBS = Boolean
						.parseBoolean(L2JTeonEventMods.getProperty(
								"FactionKoofsNoobs", "False"));
				KOOFS_NAME_TEAM = L2JTeonEventMods.getProperty("KoofsTeamName",
						"koofs");
				NOOBS_NAME_TEAM = L2JTeonEventMods.getProperty("NoobsTeamName",
						"noobs");
				KOOFS_NAME_COLOR = Integer.decode("0x"
						+ L2JTeonEventMods.getProperty("KoofsColorName",
								"00FFFF"));
				NOOBS_NAME_COLOR = Integer.decode("0x"
						+ L2JTeonEventMods.getProperty("NoobsColorName",
								"00FF00"));
				ALT_PLAYER_CAN_DROP_AA = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("PlayerCanDropAncientAdena", "False"));
				PLAYER_DROP_AA = Integer.parseInt(L2JTeonEventMods.getProperty(
						"DropAncientAdena", "1"));
				ALLOW_ADENA_REWARD = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("PlayerGetAdenaByPvP", "False"));
				ADENA_NUMBER_REWARD_ON_PVP = Integer.parseInt(L2JTeonEventMods
						.getProperty("AmmountAdenaGetByPvP", "1"));
				LOOSE_ADENA_ON_DIE = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("PlayerLooseAdena", "False"));
				ADENA_NUMBER_LOST_ON_DIE = Integer.parseInt(L2JTeonEventMods
						.getProperty("AmmountAdenaLostWhenDies", "1"));
				ALT_ANNOUNCE_PK = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("NoticePK", "False"));
				FACTION_ANNOUNCE_TIME = Integer.parseInt(L2JTeonEventMods
						.getProperty("AnnounceTimeFaction", "0"));
				// -------------------- //
				// Rebith System //
				// -------------------- //
				REBIRTH_ITEM = Integer.parseInt(L2JTeonEventMods.getProperty(
						"RebirthItemId", "0"));
				REBIRTH_SKILL1 = Integer.parseInt(L2JTeonEventMods.getProperty(
						"RewardSKill1", "0"));
				REBIRTH_SKILL1_LVL = Integer.parseInt(L2JTeonEventMods
						.getProperty("RewardSKillLvL1", "0"));
				REBIRTH_SKILL2 = Integer.parseInt(L2JTeonEventMods.getProperty(
						"RewardSKill2", "0"));
				REBIRTH_SKILL2_LVL = Integer.parseInt(L2JTeonEventMods
						.getProperty("RewardSKillLvL2", "0"));
				REBIRTH_SKILL3 = Integer.parseInt(L2JTeonEventMods.getProperty(
						"RewardSKill3", "0"));
				REBIRTH_SKILL3_LVL = Integer.parseInt(L2JTeonEventMods
						.getProperty("RewardSKillLvL3", "0"));
				REBIRTH_SKILL4 = Integer.parseInt(L2JTeonEventMods.getProperty(
						"RewardSKill4", "0"));
				REBIRTH_SKILL4_LVL = Integer.parseInt(L2JTeonEventMods
						.getProperty("RewardSKillLvL4", "0"));
				REBIRTH_SKILL5 = Integer.parseInt(L2JTeonEventMods.getProperty(
						"RewardSKill5", "0"));
				REBIRTH_SKILL5_LVL = Integer.parseInt(L2JTeonEventMods
						.getProperty("RewardSKillLvL5", "0"));
				REBIRTH_SKILL6 = Integer.parseInt(L2JTeonEventMods.getProperty(
						"RewardSKill6", "0"));
				REBIRTH_SKILL6_LVL = Integer.parseInt(L2JTeonEventMods
						.getProperty("RewardSKillLvL6", "0"));
				REBIRTH_SKILL7 = Integer.parseInt(L2JTeonEventMods.getProperty(
						"RewardSKill7", "0"));
				REBIRTH_SKILL7_LVL = Integer.parseInt(L2JTeonEventMods
						.getProperty("RewardSKillLvL7", "0"));
				REBIRTH_SKILL8 = Integer.parseInt(L2JTeonEventMods.getProperty(
						"RewardSKill8", "0"));
				REBIRTH_SKILL8_LVL = Integer.parseInt(L2JTeonEventMods
						.getProperty("RewardSKillLvL8", "0"));
				REBIRTH_SKILL9 = Integer.parseInt(L2JTeonEventMods.getProperty(
						"RewardSKill9", "0"));
				REBIRTH_SKILL9_LVL = Integer.parseInt(L2JTeonEventMods
						.getProperty("RewardSKillLvL9", "0"));
				REBIRTH_SKILL10 = Integer.parseInt(L2JTeonEventMods
						.getProperty("RewardSKill10", "0"));
				REBIRTH_SKILL10_LVL = Integer.parseInt(L2JTeonEventMods
						.getProperty("RewardSKillLvL10", "0"));
				// -------------------- //
				// RAID Event Engine //
				// -------------------- //
				RAID_SYSTEM_ENABLED = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("RaidEnginesEnabled", "False"));
				RAID_SYSTEM_GIVE_BUFFS = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("RaidGiveBuffs", "True"));
				RAID_SYSTEM_RESURRECT_PLAYER = Boolean
						.parseBoolean(L2JTeonEventMods.getProperty(
								"RaidResurrectPlayer", "True"));
				RAID_SYSTEM_MAX_EVENTS = Integer.parseInt(L2JTeonEventMods
						.getProperty("RaidMaxNumEvents", "3"));
				RAID_SYSTEM_FIGHT_TIME = Integer.parseInt(L2JTeonEventMods
						.getProperty("RaidSystemFightTime", "60"));
				if (RAID_SYSTEM_MAX_EVENTS == 0) {
					RAID_SYSTEM_ENABLED = false;
					System.out
							.println("Raid Engine[Config.load()]: Invalid config property: Max Events = 0?!");
				}
				// -------------------- //
				// Wedding System //
				// -------------------- //
				ALLOW_WEDDING = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("AllowWedding", "True"));
				WEDDING_PRICE = Integer.parseInt(L2JTeonEventMods.getProperty(
						"WeddingPrice", "500000"));
				WEDDING_PUNISH_INFIDELITY = Boolean
						.parseBoolean(L2JTeonEventMods.getProperty(
								"WeddingPunishInfidelity", "True"));
				WEDDING_TELEPORT = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("WeddingTeleport", "True"));
				WEDDING_TELEPORT_PRICE = Integer.parseInt(L2JTeonEventMods
						.getProperty("WeddingTeleportPrice", "500000"));
				WEDDING_TELEPORT_INTERVAL = Integer.parseInt(L2JTeonEventMods
						.getProperty("WeddingTeleportInterval", "120"));
				WEDDING_SAMESEX = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("WeddingAllowSameSex", "False"));
				// -------------------- //
				// Champion Mods //
				// -------------------- //
				CHAMPION_ENABLE = Boolean.parseBoolean(L2JTeonEventMods
						.getProperty("ChampionEnable", "False"));
				CHAMPION_FREQUENCY = Integer.parseInt(L2JTeonEventMods
						.getProperty("ChampionFrequency", "0"));
				CHAMPION_MIN_LVL = Integer.parseInt(L2JTeonEventMods
						.getProperty("ChampionMinLevel", "20"));
				CHAMPION_MAX_LVL = Integer.parseInt(L2JTeonEventMods
						.getProperty("ChampionMaxLevel", "60"));
				CHAMPION_HP = Integer.parseInt(L2JTeonEventMods.getProperty(
						"ChampionHp", "7"));
				CHAMPION_HP_REGEN = Float.parseFloat(L2JTeonEventMods
						.getProperty("ChampionHpRegen", "1."));
				CHAMPION_REWARDS = Integer.parseInt(L2JTeonEventMods
						.getProperty("ChampionRewards", "8"));
				CHAMPION_ADENAS_REWARDS = Integer.parseInt(L2JTeonEventMods
						.getProperty("ChampionAdenasRewards", "1"));
				CHAMPION_ATK = Float.parseFloat(L2JTeonEventMods.getProperty(
						"ChampionAtk", "1."));
				CHAMPION_SPD_ATK = Float.parseFloat(L2JTeonEventMods
						.getProperty("ChampionSpdAtk", "1."));
				CHAMPION_REWARD = Integer.parseInt(L2JTeonEventMods
						.getProperty("ChampionRewardItem", "0"));
				CHAMPION_REWARD_ID = Integer.parseInt(L2JTeonEventMods
						.getProperty("ChampionRewardItemID", "6393"));
				CHAMPION_REWARD_QTY = Integer.parseInt(L2JTeonEventMods
						.getProperty("ChampionRewardItemQty", "1"));
			} catch (Exception e) {
				e.printStackTrace();
			...
			try {
				...
				// **************************//
				/** Away System **/
				ALLOW_AWAY_STATUS = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("AllowAwayStatus", "False"));
				AWAY_ALLOW_INTERFERENCE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("AwayAllowInterference", "False"));
				AWAY_PLAYER_TAKE_AGGRO = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("AwayPlayerTakeAggro", "False"));
				AWAY_TITLE_COLOR = Integer
						.decode("0x"
								+ L2JTeonCustom.getProperty("AwayTitleColor",
										"0000FF"));
				AWAY_TIMER = Integer.parseInt(L2JTeonCustom.getProperty(
						"AwayTimer", "30"));
				BACK_TIMER = Integer.parseInt(L2JTeonCustom.getProperty(
						"BackTimer", "30"));
				AWAY_PEACE_ZONE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("AwayOnlyInPeaceZone", "False"));
				/** Remote Class Master by Danielmwx **/
				ALLOW_REMOTE_CLASS_MASTERS = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("AllowRemoteClassMasters", "False"));
				/** L2Walker Protection by Danielmwx **/
				ALLOW_L2WALKER_PROTECTION = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("L2WalkerProtection", "False"));
				PVP_SAME_IP = Boolean.parseBoolean(L2JTeonCustom.getProperty(
						"PvPSameIP", "False"));
				ALLOW_TRADEOFF_VOICE_COMMAND = Boolean
						.parseBoolean(L2JTeonCustom.getProperty(
								"TradeOffCommand", "False"));
				ONLINE_VOICE_COMMAND = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("OnlineVCommand", "False"));
				// **************************//
				/* Baby Pets Customizations */
				// **************************//
				BABY_PETS_CAN_GROWUP = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("BabyPetsCanGrowUp", "False"));
				WOLF_PETS_CAN_GROWUP = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("WolfPetsCanGrowUp", "False"));
				BABY_PETS_GROWUP_LVL = Integer.parseInt(L2JTeonCustom
						.getProperty("BabyPetsGrowUpLvl", "65"));
				// ********************//
				/* Character Statistics */
				// ********************//
				MAX_RUN_SPEED = Integer.parseInt(L2JTeonCustom.getProperty(
						"MaxRunSpeed", "250"));
				MAX_EVASION = Integer.parseInt(L2JTeonCustom.getProperty(
						"MaxEvasion", "200"));
				MAX_MCRIT_RATE = Integer.parseInt(L2JTeonCustom.getProperty(
						"MaxMCritRate", "150"));
				MAX_RCRIT = Integer.parseInt(L2JTeonCustom.getProperty(
						"MaxCritical", "500"));
				MAX_PATK_SPEED = Integer.parseInt(L2JTeonCustom.getProperty(
						"MaxPAtkSpeed", "0"));
				MAX_MATK_SPEED = Integer.parseInt(L2JTeonCustom.getProperty(
						"MaxMAtkSpeed", "0"));
				PLAYER_PROTECTION_SYSTEM = Integer.parseInt(L2JTeonCustom
						.getProperty("PlayerProtectionLevel", "0"));
				ALT_DAGGER_DMG_VS_ROBE = Float.parseFloat(L2JTeonCustom
						.getProperty("DaggerVSRobe", "1.00"));
				ALT_DAGGER_DMG_VS_LIGHT = Float.parseFloat(L2JTeonCustom
						.getProperty("DaggerVSLight", "1.20"));
				ALT_DAGGER_DMG_VS_HEAVY = Float.parseFloat(L2JTeonCustom
						.getProperty("DaggerVSHeavy", "1.40"));
				FRONT_BLOW_SUCCESS = Integer.parseInt(L2JTeonCustom
						.getProperty("FrontBlow", "50"));
				BACK_BLOW_SUCCESS = Integer.parseInt(L2JTeonCustom.getProperty(
						"BackBlow", "70"));
				SIDE_BLOW_SUCCESS = Integer.parseInt(L2JTeonCustom.getProperty(
						"SideBlow", "60"));
				DISABLE_GRADE_PENALTIES = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("DisableGradePenalties", "False"));
				DISABLE_WEIGHT_PENALTIES = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("DisableWeightPenalties", "False"));
				DONATOR_DELETE_RENTED_ITEMS = Boolean
						.parseBoolean(L2JTeonCustom.getProperty(
								"DonatorDeleteRentedItems", "False"));
				DONATOR_NAME_COLOR = Integer.decode("0x"
						+ L2JTeonCustom.getProperty("DonatorColorName",
								"00FFFF"));
				DONATOR_ITEMS = Boolean.parseBoolean(L2JTeonCustom.getProperty(
						"AllowDonatorItems", "False"));
				DONATORS_REVIVE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("AllowDonatorAutoRevive", "False"));
				HERO_CUSTOM_ITEMS = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("EnableHeroCustomItem", "False"));
				Config.ALLOW_DONATORS_UNLEGIT_SKILLS = Boolean
						.parseBoolean(L2JTeonCustom.getProperty(
								"AllowDonatorsUnlegit", "False"));
				CHAR_TITLE = Boolean.parseBoolean(L2JTeonCustom.getProperty(
						"CharTitle", "False"));
				ADD_CHAR_TITLE = L2JTeonCustom.getProperty("CharAddTitle",
						"TeonDevTeam");
				CUSTOM_RUN_SPEED = Integer.parseInt(L2JTeonCustom.getProperty(
						"CustomRunSpeed", "0"));
				KEEP_BUFFS_ON_DEATH = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("KeepBuffsOnDeath", "False"));
				DEATH_PENALTY_CHANCE = Integer.parseInt(L2JTeonCustom
						.getProperty("DeathPenaltyChance", "20"));
				SET_LVL_ON_START = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("SetHighLevelOnStart", "False"));
				HIGH_LEVEL_ON_START_FOR_SUBCLASS = Boolean
						.parseBoolean(L2JTeonCustom.getProperty(
								"HighLevelOnStartForSubclass", "True"));
				CUSTOM_STARTER_ITEMS_ENABLED = Boolean
						.parseBoolean(L2JTeonCustom.getProperty(
				...
				if (Config.CUSTOM_STARTER_ITEMS_ENABLED) {
					String[] propertySplit = L2JTeonCustom.getProperty(
						...
						if (starteritemsSplit.length != 2) {
							...
							try {
								CUSTOM_STARTER_ITEMS
										.add(new int[] {
												Integer
														.parseInt(starteritemsSplit[0]),
												Integer
														.parseInt(starteritemsSplit[1]) });
				...
				/* NPC Customizations */
				// ********************//
				GAME_VIEWNPC = Boolean.parseBoolean(L2JTeonCustom.getProperty(
						"GameViewNpc", "False"));
				GAME_VIEWNPC_COMBAT = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("GameViewNpcCombat", "False"));
				GAME_VIEWNPC_BASIC = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("GameViewNpcBasic", "False"));
				GAME_VIEWNPC_DROP = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("GameViewNpcDrop", "False"));
				GAME_VIEWNPC_QUESTDROP = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("GameViewNpcQuestDrop", "False"));
				MIN_MONSTER_ANIMATION = Integer.parseInt(L2JTeonCustom
						.getProperty("MinMonsterAnimation", "0"));
				MAX_MONSTER_ANIMATION = Integer.parseInt(L2JTeonCustom
						.getProperty("MaxMonsterAnimation", "0"));
				RAID_FOSSILIZATION_PENALTY = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("RaidFossilizationPenalty", "False"));
				// ********************//
				/* Player Command */
				// ********************//
				ALLOW_AUTOHERBS_CMD = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("AllowAutoHerbsCommand", "False"));
				ALLOW_WITHDRAW_CWH_CMD = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("AllowPlayersWithdrawCWH", "False"));
				// ********************//
				/* Announcements */
				// ********************//
				SHOW_HTML_WELCOME = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("ShowTeonInfo", "True"));
				SHOW_GM_LOGIN = Boolean.parseBoolean(L2JTeonCustom.getProperty(
						"ShowGMLogin", "False"));
				SHOW_L2J_LICENSE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("ShowL2JLicense", "False"));
				SHOW_HTML_NEWBIE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("ShowHTMLNewbie", "False"));
				LEVEL_HTML_NEWBIE = Integer.parseInt(L2JTeonCustom.getProperty(
						"LevelShowHTMLNewbie", "10"));
				ONLINE_PLAYERS_AT_STARTUP = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("ShowOnlinePlayersAtStartup", "False"));
				PLAYERS_ONLINE_TRICK = Integer.parseInt(L2JTeonCustom
						.getProperty("OnlinePlayerCountTrick", "0"));
				ONLINE_PLAYERS_ANNOUNCE_INTERVAL = Integer
						.parseInt(L2JTeonCustom.getProperty(
								"OnlinePlayersAnnounceInterval", "900000"));
				ANNOUNCE_CASTLE_LORDS = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("AnnounceCastleLords", "False"));
				ENABLE_PK_INFO = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("EnablePkInfo", "False"));
				NPC_ANNOUNCER_DONATOR_ONLY = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("NpcAnnouncerDonatorOnly", "False"));
				ALLOW_NPC_ANNOUNCER = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("AllowNpcAnnouncer", "False"));
				NPC_ANNOUNCER_PRICE_PER_ANNOUNCE = Integer
						.parseInt(L2JTeonCustom.getProperty("PricePerAnnounce",
								"10000"));
				NPC_ANNOUNCER_MAX_ANNOUNCES_PER_DAY = Integer
						.parseInt(L2JTeonCustom.getProperty("AnnouncesPerDay",
								"20"));
				NPC_ANNOUNCER_MIN_LVL_TO_ANNOUNCE = Integer
						.parseInt(L2JTeonCustom.getProperty(
								"MinLevelToAnnounce", "0"));
				NPC_ANNOUNCER_MAX_LVL_TO_ANNOUNCE = Integer
						.parseInt(L2JTeonCustom.getProperty(
								"MaxLevelToAnnounce", "80"));
				// ********************//
				/* Clan. Customizes. */
				// ********************//
				CLAN_RAISE_FIRST_COST = Integer.parseInt(L2JTeonCustom
						.getProperty("ClanFirstCost", "650000"));
				CLAN_RAISE_SEC_COST = Integer.parseInt(L2JTeonCustom
						.getProperty("ClanSecondCOst", "2500000"));
				CLAN_MEMBERS_FIRST = Integer.parseInt(L2JTeonCustom
						.getProperty("ClanMembersNeedSix", "30"));
				CLAN_MEMBERS_SEC = Integer.parseInt(L2JTeonCustom.getProperty(
						"ClanMembersNeedSeven", "80"));
				CLAN_MEMBERS_THIRD = Integer.parseInt(L2JTeonCustom
						.getProperty("ClanMembersNeedEight", "120"));
				CLAN_REPUTATION_FIRST = Integer.parseInt(L2JTeonCustom
						.getProperty("ClanReputationSix", "10000"));
				CLAN_REPUTATION_SEC = Integer.parseInt(L2JTeonCustom
						.getProperty("ClanReputationSeven", "20000"));
				CLAN_REPUTATION_THIRD = Integer.parseInt(L2JTeonCustom
						.getProperty("ClanReputationEight", "40000"));
				CLAN_SP_FIRST = Integer.parseInt(L2JTeonCustom.getProperty(
						"ClanSpFirst", "30000"));
				CLAN_SP_SEC = Integer.parseInt(L2JTeonCustom.getProperty(
						"ClanSpSecond", "150000"));
				CLAN_SP_THIRD = Integer.parseInt(L2JTeonCustom.getProperty(
						"ClanSpThird", "500000"));
				CLAN_SP_FORTH = Integer.parseInt(L2JTeonCustom.getProperty(
						"ClanSpForth", "1400000"));
				CLAN_SP_FIFTH = Integer.parseInt(L2JTeonCustom.getProperty(
						"ClanSpFifth", "3500000"));
				// ********************//
				/* Serv. Customizes. */
				// ********************//
				LOGIN_RESTART_WITH_GAMESERVER = Boolean
						.parseBoolean(L2JTeonCustom.getProperty(
								"LoginRestartWithGameserver", "False"));
				LOGIN_RESTART_BY_TIME = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("LoginRestartByTime", "False"));
				LOGIN_RESTART_TIME = Integer.parseInt(L2JTeonCustom
						.getProperty("LoginRestartTime", "60"));
				SAFE_SIGTERM = Boolean.parseBoolean(L2JTeonCustom.getProperty(
						"SafeSigterm", "False"));
				GM_OVER_ENCHANT = Integer.parseInt(L2JTeonCustom.getProperty(
						"GMOverEnchant", "26"));
				ENCHANT_MAX_ALLOWED_WEAPON = Integer.parseInt(L2JTeonCustom
						.getProperty("EnchantMaxAllowedWeapon", "25"));
				ENCHANT_MAX_ALLOWED_ARMOR = Integer.parseInt(L2JTeonCustom
						.getProperty("EnchantMaxAllowedArmor", "25"));
				ENCHANT_MAX_ALLOWED_JEWELRY = Integer.parseInt(L2JTeonCustom
						.getProperty("EnchantMaxAllowedJewelry", "25"));
				STARTING_AA = Integer.parseInt(L2JTeonCustom.getProperty(
						"StartingAA", "0"));
				USE_CHAT_FILTER = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("UseChatFilter", "False"));
				USE_POWERFULL_CHAT_FILTER = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("UsePowerfullChatFilter", "False"));
				CHAT_FILTER_CHARS = L2JTeonCustom.getProperty(
						"ChatFilterChars", "***");
				CHAT_FILTER_PUNISHMENT = Integer.parseInt(L2JTeonCustom
						.getProperty("ChatFilterPunishment", "1"));
				CHAT_FILTER_PUNISHMENT_TIME = Integer.parseInt(L2JTeonCustom
						.getProperty("ChatFilterPunishmentTime", "5"));
				CHECK_SKILLS_ON_ENTER = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("CheckSkillsOnEnter", "False"));
				ALLOWED_SKILLS = L2JTeonCustom
						.getProperty(
								"AllowedSkills",
								"541,542,543,544,545,546,547,548,549,550,551,552,553,554,555,556,557,558,617,618,619");
				...
				MANA_POTION_RES = Integer.parseInt(L2JTeonCustom.getProperty(
						"ManaPotionMPRes", "200")); // Mana Potion Custom
													// Regeneration
				SPAWN_CHAR = Boolean.parseBoolean(L2JTeonCustom.getProperty(
						"CustomSpawn", "False"));
				...
				/* Misc. Customizes. */
				// ********************//
				STRICT_HERO_SYSTEM = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("StrictHeroSystem", "True"));
				FLYING_WYVERN_DURING_SIEGE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("FlyingWyvernDuringSiege", "False"));
				ES_SP_BOOK_NEEDED = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("EnchantSkillSpBookNeeded", "True"));
				LIFE_CRYSTAL_NEEDED = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("LifeCrystalNeeded", "True"));
				ELIXIRS_REUSE_DELAY = Integer.parseInt(L2JTeonCustom
						.getProperty("ElixirsDelay", "0")) * 1000;
				REMOVE_CASTLE_CIRCLETS = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("RemoveCastleCirclets", "True"));
				ENABLE_WAREHOUSESORTING_CLAN = Boolean
						.parseBoolean(L2JTeonCustom.getProperty(
								"EnableWarehouseSortingClan", "False"));
				ENABLE_WAREHOUSESORTING_PRIVATE = Boolean
						.parseBoolean(L2JTeonCustom.getProperty(
								"EnableWarehouseSortingPrivate", "False"));
				ENABLE_WAREHOUSESORTING_FREIGHT = Boolean
						.parseBoolean(L2JTeonCustom.getProperty(
								"EnableWarehouseSortingFreight", "False"));
				DISABLE_SUMMON_IN_COMBAT = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("DisableSummonInCombat", "True"));
				ALT_PERFECT_SHLD_BLOCK = Integer.parseInt(L2JTeonCustom
						.getProperty("AltPerfectShieldBlockRate", "5"));
				CUSTOM_SPAWNLIST_TABLE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("CustomSpawnlistTable", "False"));
				SAVE_GMSPAWN_ON_CUSTOM = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("SaveGmSpawnOnCustom", "False"));
				DELETE_GMSPAWN_ON_CUSTOM = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("DeleteGmSpawnOnCustom", "False"));
				CUSTOM_NPC_TABLE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("CustomNpcTable", "False"));
				CUSTOM_ETCITEM_TABLE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("CustomEtcitemTable", "False"));
				CUSTOM_ARMOR_TABLE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("CustomArmorTable", "False"));
				CUSTOM_ARMORSETS_TABLE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("CustomArmorSetsTable", "False"));
				CUSTOM_WEAPON_TABLE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("CustomWeaponTable", "False"));
				CUSTOM_TELEPORT_TABLE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("CustomTeleportTable", "False"));
				CUSTOM_DROPLIST_TABLE = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("CustomDroplistTable", "False"));
				CUSTOM_MERCHANT_TABLES = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("CustomMerchantTables", "False"));
				ENABLE_MODIFY_SKILL_DURATION = Boolean
						.parseBoolean(L2JTeonCustom.getProperty(
				...
				if (ENABLE_MODIFY_SKILL_DURATION) {
					...
					propertySplit = L2JTeonCustom.getProperty(
							"SkillDurationList", "").split(";");
					for (String skill : propertySplit) {
						String[] skillSplit = skill.split(",");
						if (skillSplit.length != 2) {
							System.out
									.println("[SkillDurationList]: invalid config property -> SkillDurationList \""
											+ skill + "\"");
						} else {
							try {
								SKILL_DURATION_LIST.put(Integer
										.parseInt(skillSplit[0]), Integer
										.parseInt(skillSplit[1]));
							} catch (NumberFormatException nfe) {
								if (!skill.equals("")) {
									System.out
											.println("[SkillDurationList]: invalid config property -> SkillList \""
													+ skillSplit[0]
													+ "\""
													+ skillSplit[1]);
								}
				...
				ENABLE_NO_AUTOLEARN_LIST = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("EnableNoAutoLearnList", "False"));
				if (ENABLE_NO_AUTOLEARN_LIST) {
					NO_AUTOLEARN_LIST = new FastList<Integer>();
					String[] propertySplit;
					propertySplit = L2JTeonCustom.getProperty(
							"NoAutoLearnList", "").split(";");
					for (String skill : propertySplit) {
						try {
							...
							if (!skill.equals("")) {
								System.out
										.println("[NoAutoLearnList]: invalid config property -> NoAutoLearnList \""
												+ skill);
							}
						}
					}
				...
				/* Banking System */
				// **********************//
				BANKING_SYSTEM_ENABLED = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("BankingSystemEnabled", "False"));
				BANKING_SYSTEM_ADENA = Integer.parseInt(L2JTeonCustom
						.getProperty("BankingSystemAdena", "0"));
				BANKING_SYSTEM_GOLDBARS = Integer.parseInt(L2JTeonCustom
						.getProperty("BankingSystemGoldBars", "0"));
				// ************************//
				/* PvP E Pk Color System */
				// **********************//
				PVP_COLOR_SYSTEM_ENABLED = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("EnablePvPColorSystem", "False"));
				PVP_AMOUNT1 = Integer.parseInt(L2JTeonCustom.getProperty(
						"PvpAmount1", "500"));
				PVP_AMOUNT2 = Integer.parseInt(L2JTeonCustom.getProperty(
						"PvpAmount2", "1000"));
				PVP_AMOUNT3 = Integer.parseInt(L2JTeonCustom.getProperty(
						"PvpAmount3", "1500"));
				PVP_AMOUNT4 = Integer.parseInt(L2JTeonCustom.getProperty(
						"PvpAmount4", "2500"));
				PVP_AMOUNT5 = Integer.parseInt(L2JTeonCustom.getProperty(
						"PvpAmount5", "5000"));
				NAME_COLOR_FOR_PVP_AMOUNT1 = Integer.decode("0x"
						+ L2JTeonCustom
								.getProperty("ColorForAmount1", "00FF00"));
				NAME_COLOR_FOR_PVP_AMOUNT2 = Integer.decode("0x"
						+ L2JTeonCustom
								.getProperty("ColorForAmount2", "00FF00"));
				NAME_COLOR_FOR_PVP_AMOUNT3 = Integer.decode("0x"
						+ L2JTeonCustom
								.getProperty("ColorForAmount3", "00FF00"));
				NAME_COLOR_FOR_PVP_AMOUNT4 = Integer.decode("0x"
						+ L2JTeonCustom
								.getProperty("ColorForAmount4", "00FF00"));
				NAME_COLOR_FOR_PVP_AMOUNT5 = Integer.decode("0x"
						+ L2JTeonCustom
								.getProperty("ColorForAmount4", "00FF00"));
				PK_COLOR_SYSTEM_ENABLED = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("EnablePkColorSystem", "False"));
				PK_AMOUNT1 = Integer.parseInt(L2JTeonCustom.getProperty(
						"PkAmount1", "500"));
				PK_AMOUNT2 = Integer.parseInt(L2JTeonCustom.getProperty(
						"PkAmount2", "1000"));
				PK_AMOUNT3 = Integer.parseInt(L2JTeonCustom.getProperty(
						"PkAmount3", "1500"));
				PK_AMOUNT4 = Integer.parseInt(L2JTeonCustom.getProperty(
						"PkAmount4", "2500"));
				PK_AMOUNT5 = Integer.parseInt(L2JTeonCustom.getProperty(
						"PkAmount5", "5000"));
				TITLE_COLOR_FOR_PK_AMOUNT1 = Integer.decode("0x"
						+ L2JTeonCustom
								.getProperty("TitleForAmount1", "00FF00"));
				TITLE_COLOR_FOR_PK_AMOUNT2 = Integer.decode("0x"
						+ L2JTeonCustom
								.getProperty("TitleForAmount2", "00FF00"));
				TITLE_COLOR_FOR_PK_AMOUNT3 = Integer.decode("0x"
						+ L2JTeonCustom
								.getProperty("TitleForAmount3", "00FF00"));
				TITLE_COLOR_FOR_PK_AMOUNT4 = Integer.decode("0x"
						+ L2JTeonCustom
								.getProperty("TitleForAmount4", "00FF00"));
				TITLE_COLOR_FOR_PK_AMOUNT5 = Integer.decode("0x"
						+ L2JTeonCustom
								.getProperty("TitleForAmount5", "00FF00"));
				// PvP and PK Reward
				ALLOW_PVP_REWARD = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("AllowPvpRewardSystem", "False"));
				PVP_REWARD_ITEM = Integer.parseInt(L2JTeonCustom.getProperty(
						"PvpRewardItem", "57"));
				PVP_REWARD_COUNT = Integer.parseInt(L2JTeonCustom.getProperty(
						"PvpRewardAmount", "1"));
				ALLOW_PK_REWARD = Boolean.parseBoolean(L2JTeonCustom
						.getProperty("AllowPkRewardSystem", "False"));
				PK_REWARD_ITEM = Integer.parseInt(L2JTeonCustom.getProperty(
						"PkRewardItem", "57"));
				PK_REWARD_COUNT = Integer.parseInt(L2JTeonCustom.getProperty(
						"PkRewardAmount", "1"));
			} catch (Exception e) {
				e.printStackTrace();
			...
			try {
				...
				is.close();
				ALT_GAME_REQUIRE_CASTLE_DAWN = Boolean
						.parseBoolean(SevenSettings.getProperty(
								"AltRequireCastleForDawn", "False"));
				ALT_GAME_REQUIRE_CLAN_CASTLE = Boolean
						.parseBoolean(SevenSettings.getProperty(
								"AltRequireClanCastle", "False"));
				ALT_FESTIVAL_MIN_PLAYER = Integer.parseInt(SevenSettings
						.getProperty("AltFestivalMinPlayer", "5"));
			...
			try {
				...
				is.close();
				/* KARMA SYSTEM */
				KARMA_MIN_KARMA = Integer.parseInt(pvpSettings.getProperty(
						"MinKarma", "240"));
				KARMA_MAX_KARMA = Integer.parseInt(pvpSettings.getProperty(
						"MaxKarma", "10000"));
				KARMA_XP_DIVIDER = Integer.parseInt(pvpSettings.getProperty(
						"XPDivider", "260"));
				KARMA_LOST_BASE = Integer.parseInt(pvpSettings.getProperty(
						"BaseKarmaLost", "0"));
				KARMA_DROP_GM = Boolean.parseBoolean(pvpSettings.getProperty(
						"CanGMDropEquipment", "False"));
				KARMA_AWARD_PK_KILL = Boolean.parseBoolean(pvpSettings
						.getProperty("AwardPKKillPVPPoint", "True"));
				KARMA_PK_LIMIT = Integer.parseInt(pvpSettings.getProperty(
				...
				PVP_NORMAL_TIME = Integer.parseInt(pvpSettings.getProperty(
						"PvPVsNormalTime", "15000"));
				PVP_PVP_TIME = Integer.parseInt(pvpSettings.getProperty(
						"PvPVsPvPTime", "30000"));
			} catch (Exception e) {
				e.printStackTrace();
			...
			try {
				...
				Settings.load(is);
				is.close();
				FS_TIME_ATTACK = Integer.parseInt(Settings.getProperty(
						"TimeOfAttack", "50"));
				FS_TIME_COOLDOWN = Integer.parseInt(Settings.getProperty(
						"TimeOfCoolDown", "5"));
				FS_TIME_ENTRY = Integer.parseInt(Settings.getProperty(
						"TimeOfEntry", "3"));
				FS_TIME_WARMUP = Integer.parseInt(Settings.getProperty(
						"TimeOfWarmUp", "2"));
				FS_PARTY_MEMBER_COUNT = Integer.parseInt(Settings.getProperty(
			...
			try {
				...
				DEBUG = Boolean.parseBoolean(serverSettings.getProperty(
						"Debug", "False"));
				DEVELOPER = Boolean.parseBoolean(serverSettings.getProperty(
						"Developer", "False"));
				...
				GM_MIN = Integer.parseInt(serverSettings.getProperty(
						"GMMinLevel", "100"));
				DATAPACK_ROOT = new File(serverSettings.getProperty(
						"DatapackRoot", ".")).getCanonicalFile(); // FIXME:
				// in
				// login?
				INTERNAL_HOSTNAME = serverSettings.getProperty(
				...
				DATABASE_MAXIDLETIME = Integer.parseInt(serverSettings
						.getProperty("MaxIdleTime", "0"));
				SHOW_LICENCE = Boolean.parseBoolean(serverSettings.getProperty(
						"ShowLicence", "True"));
				IP_UPDATE_TIME = Integer.parseInt(serverSettings.getProperty(
						"IpUpdateTime", "0"));
				FORCE_GGAUTH = Boolean.parseBoolean(serverSettings.getProperty(
						"ForceGGAuth", "False"));
	...
	private static void loadFloodProtectorConfigs(final Properties properties) {
		...
		loadFloodProtectorConfig(properties, FLOOD_PROTECTOR_UNK_PACKETS,
				"UnkPackets", "5");
		loadFloodProtectorConfig(properties, FLOOD_PROTECTOR_BUFFER, "Buffer",
				"5");
