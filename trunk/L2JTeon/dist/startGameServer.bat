...
java -Dfile.encoding=UTF-8 -Xmx512m -cp bsf.jar;jython-engine.jar;java-engine.jar;bsh-engine.jar;bsh-2.0b5.jar;commons-logging-1.1.jar;mmocore.jar;javolution.jar;c3p0-0.9.1.2.jar;mysql-connector-java-5.1.5-bin.jar;l2jteon.jar;jython.jar net.sf.l2j.gameserver.GameServer
REM
