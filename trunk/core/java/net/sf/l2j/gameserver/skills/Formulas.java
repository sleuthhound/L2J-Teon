...
public final class Formulas
{
	...
	public static final double calcCpRegen(L2PcInstance player)
	{
		...
		// Apply CON bonus
		init *= player.getLevelMod() * Formulas.CONbonus[player.getCON()];
		if (init < 1)
			init = 1;
	 ...
	 * @param sendSysMsg Send or no a system message.
	...
	public static int calcNpcHpBonus(int CON, int baseHpMax)
	{
		...
		{
			_log.log(Level.WARNING, "Formulas: Error in NPC Data!", e);
			return baseHpMax;
		}
	}
