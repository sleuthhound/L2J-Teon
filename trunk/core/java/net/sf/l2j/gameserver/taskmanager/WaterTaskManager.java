...
{
	protected Map<L2PcInstance, Long> _waterTask = new FastMap<L2PcInstance, Long>().shared();
	...
	public boolean isInWater(L2PcInstance actor)
	{
		return _waterTask.containsKey(actor);
	}
