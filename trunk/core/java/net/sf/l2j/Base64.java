...
public class Base64
{
	...
	public static String encodeObject(Serializable serializableObject, int options)
	{
		...
		byte[] value = null;
		try (ByteArrayOutputStream baos = new ByteArrayOutputStream(); Base64.OutputStream b64os = new Base64.OutputStream(baos, ENCODE | dontBreakLines); ObjectOutputStream oos = new ObjectOutputStream((gzip == GZIP) ? new GZIPOutputStream(b64os) : b64os))
		{
