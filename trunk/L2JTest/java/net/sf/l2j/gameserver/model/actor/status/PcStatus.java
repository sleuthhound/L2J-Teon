...
public class PcStatus extends PlayableStatus
{
	...
	{
	    // if attacked by a non L2PcInstance & non L2SummonInstance the
	    // duel
	    // gets canceled
	...
	if ((attacker != null) && (attacker != getActiveChar()))
	{
		...
		if (tDmg > 0)
		{
		    ...
		    value -= tDmg;
		    fullValue = (int) value; // reduce the annouced value
		    // here as player will get a
		    // message about summon dammage
		}
	    }
		...
		{
		    setCurrentCp(getCurrentCp() - value); // Set Cp to
		    // diff of
		    // Cp vs value
