...
public class SortedWareHouseWithdrawalList extends L2GameServerPacket
{
     ...
     * @param sortorder
     *                is the integer Sortorder like 1 for A..Z (use public
     *                constant)
     */
     ...
     */
    private static class WarehouseItemNameComparator implements
	    Comparator<L2WarehouseItem>
    {
     ...
     */
    private static class WarehouseItemRecipeComparator implements
	    Comparator<L2WarehouseItem>
    {
	private int order = 0;
     ...
     */
    private static class WarehouseItemBodypartComparator implements
	    Comparator<L2WarehouseItem>
    {
	private byte order = 0;
     ...
     */
    private static class WarehouseItemGradeComparator implements
	    Comparator<L2WarehouseItem>
    {
	byte order = 0;
    ...
    /**
     * This Comparator will sort by Item Type. Unfortunatly this will only
     * have a good result if the Database Table for the ETCITEM.TYPE column
     * is fixed!
     */
    private static class WarehouseItemTypeComparator implements
	    Comparator<L2WarehouseItem>
    {
	byte order = 0;
    ...
    /**
     * This method is used to limit the given Warehouse List to:
     * <li>Everything which is no Weapon/Armor, Material, Recipe,
     * Spellbook, Scroll or Shot</li>
     * <li>Money</li>
     * 
     * @param _items
     *                complete Warehouse List
