...
public class Baium extends L2AttackableAIScript
{
	...
	private L2Character getRandomTarget(L2Npc npc)
	{
		...
		for (L2Character obj : _Zone.getCharactersInside())
		{
	...
	private void callSkillAI(L2Npc npc)
	{
		...
		// Pickup a target if no or dead victim. If Baium was hitting an angel, 15% luck he reconsiders his target.
		if (_actualVictim == null || _actualVictim.isDead() || !(_Zone.isCharacterInZone(_actualVictim)) || (_actualVictim instanceof L2MonsterInstance && Rnd.get(100) < 15))
